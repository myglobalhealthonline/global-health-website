...
beforeEach(() => {
  ...
  appointment = { id: "appointment", status: "COMPLETED", consultationCompletedAt: completedAt, email: "patient@example.test", countryCode: "BR", notificationLocale: "ES", user: { preferredLocale: "pt-BR" }, fullName: "Test Patient" };
