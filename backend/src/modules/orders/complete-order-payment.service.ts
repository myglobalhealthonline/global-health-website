...
export async function ensureOrderPaidAutomations(
  ...
  //
  // Gated on the order carrying no consultation. A mixed cart (consultation +
  // kit) runs the appointment ladder instead, and that ladder owns
  ...
  if (!hasConsult && paidOrder.items.some((i) => i.kind === "HEALTH_TEST")) {
