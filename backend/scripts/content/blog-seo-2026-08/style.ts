/** Shared article CSS — extracted verbatim from scripts/seed-blog-drafts.ts so
 *  every article seeded here renders on the same `.gh-blog` system as the
 *  existing exemplar posts. Do not hand-edit; it is a copy of that file's STYLE. */
