    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          p("In practice the certificate does not travel with you. The doctor's practice submits it to the Department electronically as part of the consultation. Your job is to make sure the doctor has your <strong>PPS number</strong> and your correct personal details, because a mismatch between the certificate and your claim is what stalls payment."),
          ul([
      ...
      },
      {
        ...
        blocks: [
          ...
          ul([
            ...
            "<strong>The doctor submits the Certificate of Incapacity for Work</strong> to the Department electronically.",
    ...
    faqs: [
      {
        ...
        a: "You need a consultation with a doctor registered with the Irish Medical Council. If the doctor finds you unfit for work, they issue a Certificate of Incapacity for Work and submit it to the Department of Social Protection electronically. Bring your PPS number to the consultation, because the certificate has to match your claim.",
      },
      {
...
const pt: LocalePost = {
  ...
  article: {
    ...
    intro:
      "O Illness Benefit é um pagamento semanal do <strong>Department of Social Protection (DSP)</strong> destinado a quem tem menos do que a idade da reforma e não pode trabalhar por doença ou lesão. É um apoio de segurança social financiado pelas contribuições PRSI, pelo que não depende dos seus rendimentos ou património. Têm de chegar duas coisas ao Departamento: o seu pedido, feito no formulário <strong>IB1</strong> ou através do MyWelfare, e um <strong>Certificate of Incapacity for Work</strong> emitido por um médico inscrito no Irish Medical Council, que o próprio médico submete por via eletrónica. É um apoio distinto da baixa legal paga pela entidade patronal.",
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          p("Na prática, o certificado não viaja consigo. É o consultório do médico que o submete eletronicamente ao Departamento. A sua parte é garantir que o médico tem o seu <strong>número PPS</strong> e os seus dados corretos, porque é a divergência entre o certificado e o pedido que trava o pagamento."),
          ul([
      ...
      },
      {
        ...
        blocks: [
          ...
          ul([
            ...
            "<strong>O médico submete o Certificate of Incapacity for Work</strong> ao Departamento, por via eletrónica.",
    ...
    faqs: [
      {
        ...
        a: "Precisa de uma consulta com um médico inscrito no Irish Medical Council. Se o médico concluir que está incapaz para o trabalho, emite um Certificate of Incapacity for Work e submete-o eletronicamente ao Department of Social Protection. Leve o número PPS à consulta, porque o certificado tem de coincidir com o seu pedido.",
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          p("En la práctica el certificado no viaja con usted. Es la consulta del médico la que lo envía electrónicamente al Departamento. Su parte consiste en asegurarse de que el médico tiene su <strong>número PPS</strong> y sus datos correctos, porque lo que bloquea el pago es la discrepancia entre el certificado y la solicitud."),
          ul([
      ...
      },
      {
        ...
        blocks: [
          ...
          ul([
            ...
            "<strong>El médico envía el Certificate of Incapacity for Work</strong> al Departamento por vía electrónica.",
    ...
    faqs: [
      {
        ...
        a: "Necesita una consulta con un médico colegiado en el Irish Medical Council. Si el médico concluye que está incapacitado para trabajar, emite un Certificate of Incapacity for Work y lo envía electrónicamente al Department of Social Protection. Lleve su número PPS a la consulta, porque el certificado debe coincidir con su solicitud.",
      },
      {
...
const cs: LocalePost = {
  ...
  article: {
    ...
    intro:
      "Illness Benefit je týdenní dávka <strong>Department of Social Protection (DSP)</strong> určená lidem pod důchodovým věkem, kteří nemohou pracovat kvůli nemoci nebo úrazu. Je financovaná z odvodů <strong>PRSI</strong>, takže nezávisí na vašich příjmech ani na majetku. Na úřad musí dorazit dvě věci: vaše žádost na formuláři <strong>IB1</strong> nebo přes MyWelfare a <strong>Certificate of Incapacity for Work</strong> vystavený lékařem registrovaným u Irish Medical Council, který jej sám odesílá elektronicky. Je to jiná dávka než zákonná nemocenská, kterou platí zaměstnavatel.",
    facts: [
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          p("V praxi potvrzení necestuje s vámi. Ordinace jej odesílá úřadu elektronicky. Vaším úkolem je zajistit, aby měl lékař vaše <strong>PPS číslo</strong> a správné údaje, protože právě nesoulad mezi potvrzením a žádostí výplatu blokuje."),
          ul([
      ...
      },
      {
        ...
        blocks: [
          ...
          ul([
            ...
            "<strong>Lékař odešle Certificate of Incapacity for Work</strong> úřadu elektronicky.",
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          p("În practică, certificatul nu călătorește cu dumneavoastră. Cabinetul îl transmite electronic instituției. Rolul dumneavoastră este să vă asigurați că medicul are <strong>numărul PPS</strong> și datele corecte, pentru că neconcordanța dintre certificat și cerere blochează plata."),
          ul([
      ...
      },
      {
        ...
        blocks: [
          ...
          ul([
            ...
            "<strong>Medicul transmite Certificate of Incapacity for Work</strong> instituției, electronic.",
    ...
    faqs: [
      {
        ...
        a: "Aveți nevoie de o consultație cu un medic înscris la Irish Medical Council. Dacă medicul conchide că sunteți inapt de muncă, eliberează un Certificate of Incapacity for Work și îl transmite electronic către Department of Social Protection. Luați numărul PPS la consultație, pentru că certificatul trebuie să corespundă cererii.",
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          ...
          p("In der Praxis reisen Sie nicht mit der Bescheinigung. Die Praxis übermittelt sie elektronisch an die Behörde. Ihre Aufgabe ist es, dafür zu sorgen, dass Ihre <strong>PPS-Nummer</strong> und Ihre Daten korrekt vorliegen — denn es ist die Abweichung zwischen Bescheinigung und Antrag, die die Zahlung stoppt."),
          ul([
      ...
      },
      {
        ...
        blocks: [
          ...
          ul([
            ...
            "<strong>Die Praxis übermittelt das Certificate of Incapacity for Work</strong> elektronisch an die Behörde.",
    ...
    faqs: [
      {
        ...
        a: "Sie brauchen eine Sprechstunde bei einer beim Irish Medical Council registrierten Ärztin oder einem Arzt. Wird Arbeitsunfähigkeit festgestellt, wird ein Certificate of Incapacity for Work ausgestellt und elektronisch an das Department of Social Protection übermittelt. Halten Sie die PPS-Nummer bereit, denn Bescheinigung und Antrag müssen übereinstimmen.",
      },
      {
