...
const cs: LocalePost = {
  ...
  title: "Výpočet nemocenské 2026: co platí zaměstnavatel a co ČSSZ",
  excerpt:
    "Nemocenská v Česku se v roce 2026 počítá ve dvou různých režimech: prvních 14 kalendářních dnů řeší zaměstnavatel náhradou mzdy za pracovní dny, od 15. dne vyplácí nemocenské ČSSZ za kalendářní dny. Vysvětlujeme přesný rozdíl, redukční hranice i praktický orientační výpočet.",
  seoTitle: "Výpočet nemocenské 2026: zaměstnavatel vs. ČSSZ",
  seoDescription:
    "Jak se počítá nemocenská v roce 2026: prvních 14 dnů náhrada mzdy od zaměstnavatele, od 15. dne nemocenské od ČSSZ, redukční hranice a orientační výpočet.",
  ...
  article: {
    ...
    eyebrow: "Česko · Finance a pracovní neschopnost",
    h1: "Výpočet nemocenské v roce 2026",
    deck: "Prvních 14 kalendářních dnů řeší zaměstnavatel, od 15. dne stát. Právě tenhle přechod mezi náhradou mzdy a nemocenským je důvod, proč si lidé částky často počítají špatně.",
    intro:
      "Když onemocníte a lékař vás uzná <strong>dočasně práce neschopnými</strong>, nezačne se od prvního dne vyplácet jedna jediná dávka. V Česku fungují <strong>dva výpočetní režimy</strong>. Během prvních 14 kalendářních dnů vám zaměstnavatel vyplácí <strong>náhradu mzdy</strong>, a to jen za pracovní dny nebo placené svátky, které byste jinak odpracovali. Od 15. kalendářního dne přebírá výplatu <strong>Česká správa sociálního zabezpečení</strong> a počítá <strong>nemocenské za kalendářní dny</strong>. V roce 2026 navíc platí nové redukční hranice 1 633 Kč, 2 449 Kč a 4 897 Kč. Pokud si tedy někdo zkusí spočítat nemocenskou jedním procentem z hrubé mzdy, téměř jistě vyjde špatně.",
    facts: [
      "1.–14. den: náhrada mzdy od zaměstnavatele",
      "Od 15. dne: nemocenské od ČSSZ",
      "V roce 2026 nové redukční hranice",
    ],
    primaryCta: { label: "Objednat online konzultaci", href: href("cs", "/services/neschopenka-online") },
    secondaryCta: { label: "Podrobné info o nemocenském ČSSZ", href: CSSZ_SICKNESS_DETAIL },
    panelChip: "Co si z článku odnést",
    panelParas: [
      "Náhrada mzdy a nemocenské nejsou totéž: počítají se z jiného základu a vyplácí je jiný subjekt.",
      "Zaměstnanec v prvních 14 dnech nedostává peníze za kalendářní dny, ale jen za směny a placené svátky, které kvůli nemoci odpadly.",
      "ČSSZ od 15. dne používá denní vyměřovací základ a od 31. i 61. dne se procento dávky zvyšuje.",
    ],
    ...
    sections: [
      {
        id: "dva-rezimy",
        nav: "Dva režimy",
        eyebrow: "Nejdůležitější rozdíl",
        h2: "Nemocenská se nepočítá jednou částkou od prvního dne",
        blocks: [
          lead("Nejčastější omyl je myslet si, že jakmile vás lékař vystaví na neschopenku, začne ČSSZ hned od prvního dne vyplácet nemocenské. V roce 2026 to tak u zaměstnance není."),
          p("První úsek nemoci řeší <strong>zaměstnavatel</strong>. Podle zákoníku práce vám během prvních 14 kalendářních dnů dočasné pracovní neschopnosti náleží <strong>náhrada mzdy</strong>. Ta se ale nepočítá za každý den v kalendáři. Vyplácí se jen za <strong>pracovní dny a placené svátky</strong>, na které vám byla rozvržena směna a které jste kvůli nemoci neodpracovali."),
          p("Teprve od <strong>15. kalendářního dne</strong> nastupuje <strong>nemocenské</strong> z nemocenského pojištění. To vyplácí ČSSZ a počítá ho po <strong>kalendářních dnech</strong>, nikoli po směnách. Proto se částka po přechodu z prvních 14 dnů do státní dávky často změní i tehdy, když vaše hrubá mzda zůstává stejná."),
          ul([
            "1.–14. kalendářní den: zaměstnavatel, náhrada mzdy, jen pracovní dny a placené svátky.",
            "Od 15. kalendářního dne: ČSSZ, nemocenské, všechny kalendářní dny trvání neschopnosti.",
            "OSVČ je jiný případ: v prvních 14 dnech jim nemocenské nenáleží vůbec a náhradu mzdy od zaměstnavatele nemají.",
          ]),
          warn("Proč bývají očekávání nižší nebo vyšší než realita", "Lidé si často vynásobí denní sazbu počtem kalendářních dnů už v prvních dvou týdnech. Jenže zaměstnavatel neproplácí soboty a neděle, pokud na ně zaměstnanec neměl směnu. Proto první výplata při neschopnosti obvykle nepůsobí intuitivně."),
        ],
      },
      {
        id: "zamestnavatel-prvnich-14",
        nav: "Prvních 14 dnů",
        eyebrow: "Náhrada mzdy",
        h2: "Jak se v roce 2026 počítá náhrada mzdy od zaměstnavatele",
        blocks: [
          lead("Pro prvních 14 kalendářních dnů není základem denní vyměřovací základ z ČSSZ, ale váš průměrný hodinový výdělek, který se nejdřív redukuje."),
          p("Zákoník práce říká, že náhrada mzdy náleží ve výši <strong>60 % průměrného redukovaného výdělku</strong>. Prakticky to znamená tři kroky. Nejprve mzdová účtárna vezme váš <strong>průměrný hodinový výdělek</strong>. Ten pak upraví obdobně jako denní vyměřovací základ pro nemocenské, jen s tím rozdílem, že příslušné redukční hranice převede na <strong>hodinové hranice</strong> koeficientem 0,175. Až z redukovaného výsledku se vezme 60 %."),
          p(`Pro rok 2026 tak z redukčních hranic nemocenského vznikají orientační hodinové hranice <strong>${EMPLOYER_HOURLY_THRESHOLDS_2026}</strong>. Do první hranice se započte 90 %, mezi první a druhou 60 %, mezi druhou a třetí 30 % a nad třetí hranici už se nepřihlíží. Výsledkem je redukovaný hodinový základ pro náhradu mzdy.`),
          p("Pak přijde až poslední krok: redukovaný hodinový základ se násobí 60 % a potom počtem neodpracovaných hodin v rozvržených směnách. Zaměstnanec se směnami tedy může mít v prvních 14 dnech vyšší nebo nižší částku než kolega se stejnou mzdou, pokud na ně dopadlo jiné rozložení pracovní doby."),
          ul([
            "Náhrada mzdy neřeší ČSSZ, ale mzdové oddělení zaměstnavatele.",
            "Počítá se z průměrného hodinového výdělku, ne přímo z hrubé mzdy za daný měsíc.",
            "Vyplácí se jen za zameškané směny a placené svátky v prvních 14 kalendářních dnech.",
            "Sazba je 60 % redukovaného průměrného výdělku.",
          ]),
          cite(`Právní základ: <a href="${LABOUR_CODE_192}" rel="nofollow noopener" target="_blank">zákoník práce § 192</a>. Přehled první fáze nemoci: <a href="${MPSV_SICKNESS_2026}" rel="nofollow noopener" target="_blank">MPSV — Nemocenské pojištění v roce 2026</a>.`),
        ],
      },
      {
        id: "cssz-od-15-dne",
        ...
        blocks: [
          lead("Od 15. kalendářního dne se logika mění. ČSSZ už nesleduje rozvržené směny, ale denní vyměřovací základ a kalendářní dny trvání pracovní neschopnosti."),
          p("ČSSZ vychází ze <strong>započitatelného příjmu</strong> v rozhodném období, které je zpravidla posledních 12 kalendářních měsíců před měsícem, v němž pracovní neschopnost vznikla. Tento příjem vydělí počtem započitatelných kalendářních dnů a tím získá <strong>denní vyměřovací základ</strong>."),
          p(`Denní vyměřovací základ se v roce 2026 redukuje podle hranic <strong>${DVZ_THRESHOLDS_2026}</strong>. Do první hranice se započte 90 %, mezi první a druhou 60 %, mezi druhou a třetí 30 % a nad třetí hranici se už nic nepočítá. Tak vznikne <strong>redukovaný denní vyměřovací základ</strong>.`),
          p("Na něj se pak aplikují procenta podle délky neschopnosti. Od 15. do 30. dne činí nemocenské <strong>60 %</strong> redukovaného denního vyměřovacího základu, od 31. do 60. dne <strong>66 %</strong> a od 61. dne <strong>72 %</strong>. Tohle je důvod, proč se dlouhá pracovní neschopnost v dalším průběhu mírně zvyšuje, i když se váš základ nijak nemění."),
          ul([
            "Od 15. dne dávka běží po kalendářních dnech včetně víkendů.",
            "Redukce pro nemocenské používá denní, ne hodinové hranice.",
            "Procento dávky se zvyšuje po 30. a 60. dni trvání neschopnosti.",
            "Podpůrčí doba je standardně nejvýše 380 kalendářních dnů od vzniku neschopnosti.",
          ]),
          cite(`ČSSZ — podrobné informace o nemocenském: <a href="${CSSZ_SICKNESS_DETAIL}" rel="nofollow noopener" target="_blank">CSSZ detail</a>. Redukční hranice a příklady výpočtu: <a href="${CSSZ_BENEFIT_CALC}" rel="nofollow noopener" target="_blank">ČSSZ — Výše a výpočet dávek</a>.`),
        ],
      },
      {
        id: "orientacni-priklad",
        nav: "Příklad",
        eyebrow: "Orientační výpočet",
        h2: "Orientační příklad: proč stejná mzda nedá stejný výsledek v každém týdnu",
        blocks: [
          lead("Ukažme si princip, ne mzdovou kalkulačku. Smyslem je pochopit, proč se částka v prvních dvou týdnech a od 15. dne liší."),
          p("Představte si zaměstnance s pravidelnou pracovní dobou pondělí až pátek, který onemocní v úterý 10. března 2026. V prvních 14 kalendářních dnech zamešká devět pracovních dnů. Zaměstnavatel proto nepočítá nic za víkendy, ale vezme průměrný hodinový výdělek, redukuje ho přes hodinové hranice roku 2026 a z výsledku vyplatí 60 % za zameškané hodiny. Pokud má zaměstnanec směny po osmi hodinách, násobí se náhrada 72 hodinami; kdyby měl směny po dvanácti hodinách, násobení vypadá jinak, i když jeho měsíční mzda může být stejná."),
          p("Jestliže pracovní neschopnost pokračuje i po 23. březnu 2026, od 24. března už vstupuje ČSSZ. Ta neřeší, jestli připadá sobota nebo úterý, ale kolik činí redukovaný denní vyměřovací základ. Ten vynásobí 60 % za den 15 až 30 neschopnosti. Pokud nemoc trvá i po 30. dni, denní dávka se zvýší na 66 %, po 60. dni na 72 %."),
          p("Je proto naprosto běžné, že zaměstnanec vidí tři různé částky: jednu ve výplatě od zaměstnavatele, druhou v prvním období nemocenského od ČSSZ a třetí, pokud nemoc trvá déle než měsíc. Nejde o chybu. Jde o tři různé kroky dané zákonem."),
          warn("K čemu je příklad dobrý", "Ne pro přesné plánování rodinného rozpočtu na koruny. To umí jen mzdová účtárna a ČSSZ z vašich skutečných údajů. Příklad má ukázat, že kalendář směn a délka nemoci mění výsledek stejně výrazně jako výše mzdy."),
        ],
      },
      {
        id: "ochranna-lhuta-osvc",
        nav: "Po skončení práce a OSVČ",
        eyebrow: "Hraniční situace",
        h2: "Co se mění po skončení zaměstnání a u OSVČ",
        blocks: [
          lead("Ne každému běží prvních 14 dnů stejně. Po skončení zaměstnání nebo u OSVČ je výsledek jiný než u běžného zaměstnance."),
          p("Pokud pracovní poměr skončil a vy onemocníte ještě v <strong>ochranné lhůtě</strong>, může nárok na nemocenské vzniknout i po skončení zaměstnání. Ochranná lhůta je standardně <strong>7 kalendářních dnů</strong>, ale jen tehdy, pokud zaměstnání trvalo alespoň tak dlouho. U kratšího zaměstnání je ochranná lhůta jen tak dlouhá, jak dlouho zaměstnání trvalo."),
          p("Podstatné ale je, že po skončení zaměstnání už vám nikdo nevyplácí náhradu mzdy za prvních 14 dnů, protože není zaměstnavatel, který by měl co nahradit. ČSSZ proto může od 15. dne vyplácet nemocenské, ale první dvoutýdenní úsek zůstává bez náhrady mzdy. To je situace, která lidi překvapuje nejčastěji."),
          p("U <strong>OSVČ</strong> je princip ještě přísnější. Nemocenské je dobrovolné pojištění a pro nárok musí být OSVČ účastna pojištění aspoň tři měsíce bezprostředně před vznikem neschopnosti. Ani když podmínku splní, první dva týdny jí nemocenské nenáleží a žádného zaměstnavatele, který by vyplácel náhradu mzdy, samozřejmě nemá."),
          ul([
            "Zaměstnanec v trvajícím pracovním poměru: prvních 14 dnů náhrada mzdy, od 15. dne nemocenské.",
            "Bývalý zaměstnanec v ochranné lhůtě: od 15. dne může vzniknout nemocenské, ale bez náhrady mzdy za první dva týdny.",
            "OSVČ: bez zaměstnavatele, bez náhrady mzdy, nemocenské až od 15. dne a jen při splnění podmínek pojištění.",
          ]),
          cite(`Podmínky ochranné lhůty a délky podpůrčí doby: <a href="${CSSZ_SICKNESS_DETAIL}" rel="nofollow noopener" target="_blank">ČSSZ — podrobné informace o nemocenském</a>. Podmínky pro OSVČ: <a href="${MPSV_SICKNESS_2026}" rel="nofollow noopener" target="_blank">MPSV — Nemocenské pojištění v roce 2026</a>.`),
        ],
      },
      {
        id: "co-zkontrolovat",
        nav: "Co zkontrolovat",
        eyebrow: "Praktické kroky",
        h2: "Co si zkontrolovat, když výplata neodpovídá očekávání",
        blocks: [
          lead("Než začnete řešit reklamaci, je dobré ověřit, ve kterém režimu se právě nacházíte a z čeho byla částka počítána."),
          ul([
            "Je stále prvních 14 kalendářních dnů, nebo už běží nemocenské od ČSSZ?",
            "Kolik pracovních dnů a hodin jste v prvních 14 dnech skutečně zameškali podle rozvrhu směn?",
            "Použila mzdová účtárna průměrný hodinový výdělek z posledního uzavřeného čtvrtletí, jak jí ukládá zákoník práce?",
            "Nezačala neschopnost těsně po skončení zaměstnání, takže náhrada mzdy vůbec nevznikla?",
            "Nejde o delší neschopnost, kde se od 31. a 61. dne zvyšuje procento dávky?",
          ]),
          p("Když si nejste jistí, jak vůbec neschopenka a eNeschopenka funguje, máme k tomu samostatný podrobnější průvodce: <a href=\"https://www.myglobalhealth.online/czechia/cs/blog/neschopenka-jak-funguje-eneschopenka\">Neschopenka: jak funguje eNeschopenka, vycházky a výplata nemocenské</a>. Ten řeší spíš proces a povinnosti. Tento článek je hlavně o penězích."),
          p("A pokud teprve potřebujete, aby lékař posoudil, jestli je pracovní neschopnost ve vašem případě odborně namístě, můžete se objednat online. Lékař ale nikdy negarantuje ani neschopenku, ani konkrétní částku dávky. To jsou dvě různé věci: o zdravotním stavu rozhoduje lékař, o dávce a jejím výpočtu rozhoduje zákon a ČSSZ."),
        ],
      },
    ],
    linksEyebrow: "Global Health Česko",
    linksH2: "Kam dál, když řešíte neschopenku i výpočet",
    linksLead: "Pokud potřebujete lékařské posouzení pracovní neschopnosti, nebo si chcete nejdřív ujasnit proces eNeschopenky, použijte některý z těchto kroků.",
    links: [
      { label: "Online konzultace pro neschopenku v Česku", href: href("cs", "/services/neschopenka-online") },
      { label: "Jak funguje eNeschopenka krok za krokem", href: "https://www.myglobalhealth.online/czechia/cs/blog/neschopenka-jak-funguje-eneschopenka" },
      { label: "Naši lékaři v Česku", href: href("cs", "/doctors") },
      { label: "Kontakt — Global Health Česko", href: href("cs", "/contact") },
    ],
    ctaBox: {
      h3: "Potřebujete nejdřív lékařské posouzení?",
      text: "Online konzultace s českým lékařem pomůže vyhodnotit, zda váš zdravotní stav pracovní neschopnost opravdu odůvodňuje. Samotný výpočet dávky pak řeší zaměstnavatel a ČSSZ podle zákona.",
    ...
    sourcesH2: "Odkud vycházejí čísla pro rok 2026",
    sourcesLead: "Použité hodnoty jsou vztažené k roku 2026 a pocházejí z aktuálních státních zdrojů a přímo z právních předpisů. Pokud hledáte úplně přesnou částku pro vlastní situaci, potřebujete svoje mzdové údaje a údaje ČSSZ.",
    sources: [
      ...
      { label: "Zákon č. 187/2006 Sb., o nemocenském pojištění", href: SICKNESS_ACT_187 },
    ],
    sourcesNote: "Global Health není součástí ČSSZ ani mzdové účtárny vašeho zaměstnavatele. Lékař může posoudit pracovní neschopnost, ale nemůže slíbit konkrétní dávku ani měnit její zákonný výpočet.",
    faqEyebrow: "FAQ",
    faqH2: "Časté dotazy k výpočtu nemocenské v roce 2026",
    faqs: [
      {
        q: "Jak se počítá nemocenská v roce 2026?",
        a: "Ve dvou krocích. Prvních 14 kalendářních dnů vyplácí zaměstnavatel náhradu mzdy jen za pracovní dny a placené svátky, a to ve výši 60 % redukovaného průměrného výdělku. Od 15. dne vyplácí ČSSZ nemocenské za kalendářní dny z redukovaného denního vyměřovacího základu.",
      },
      {
        q: "Co je rozdíl mezi náhradou mzdy a nemocenským?",
        a: "Náhrada mzdy je první fáze nemoci placená zaměstnavatelem podle zákoníku práce. Nemocenské je státní dávka z nemocenského pojištění placená ČSSZ od 15. kalendářního dne. Liší se plátce, základ výpočtu i to, zda se počítají pracovní dny nebo všechny kalendářní dny.",
      },
      {
        q: "Jaké jsou redukční hranice pro nemocenskou v roce 2026?",
        a: "Pro nemocenské z ČSSZ činí 1 633 Kč, 2 449 Kč a 4 897 Kč za den. Pro náhradu mzdy v prvních 14 dnech se používají odvozené hodinové hranice 285,78 Kč, 428,58 Kč a 856,98 Kč za hodinu, protože zákoník práce převádí redukční hranice koeficientem 0,175.",
      },
      {
        q: "Kolik procent dostanu od 15. dne pracovní neschopnosti?",
        a: "Od 15. do 30. dne činí nemocenské 60 % redukovaného denního vyměřovacího základu. Od 31. do 60. dne je to 66 % a od 61. dne 72 %. Dávka se vyplácí za kalendářní dny.",
      },
      {
        q: "Proč jsem v prvních dvou týdnech dostal méně, než jsem čekal?",
        a: "Nejspíš proto, že zaměstnavatel neproplácí první fázi po kalendářních dnech, ale jen za směny a placené svátky, které vám kvůli nemoci odpadly. Navíc se částka počítá z redukovaného průměrného hodinového výdělku, ne přímo z hrubé mzdy.",
      },
      {
        q: "Dostanu něco, když onemocním po skončení zaměstnání?",
        a: "Pokud onemocníte v ochranné lhůtě, může vám vzniknout nárok na nemocenské od 15. dne, ale náhrada mzdy od zaměstnavatele za prvních 14 dnů už nevzniká, protože pracovní poměr netrvá. Ochranná lhůta je standardně 7 kalendářních dnů, pokud poslední zaměstnání trvalo alespoň tak dlouho.",
      },
    ],
    disclaimerTitle: "Zdravotní a finanční upozornění",
    disclaimer:
      "Napsal MUDr. Vojtěch Černý, praktický lékař Global Health Česko, odborně zkontrolovala MUDr. Romana Pavlů, praktická lékařka pro dospělé. Článek obsahuje obecné informace o pravidlech pracovní neschopnosti a výpočtu dávek v Česku k 24. srpnu 2026. Nejde o individuální lékařskou, právní ani mzdovou radu. Přesnou výši náhrady mzdy stanoví váš zaměstnavatel podle vlastních mzdových podkladů, přesnou výši nemocenského stanoví ČSSZ podle vašich započitatelných příjmů a zákona. V akutním zdravotním ohrožení volejte 155 nebo 112.",
  } satisfies Article,
};
