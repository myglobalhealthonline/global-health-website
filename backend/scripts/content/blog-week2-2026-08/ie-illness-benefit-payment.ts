...
const STATUTORY_SICK_LEAVE_2026 =
  "https://www.gov.ie/en/publication/8c924-illness-benefit-and-statutory-sick-leave-in-2024/";
...
const en: LocalePost = {
  ...
  article: {
    ...
    author: TEAM_AUTHOR,
    reviewLine: "Clinical and native-language review is required before publication.",
    ...
    faqs: [
      ...
      { q: "Does it always start after three waiting days?", a: "No. With all five statutory days available it usually starts on day 6; with all five used, on day 4. If you have worked for your employer for less than 13 weeks and otherwise qualify, you serve three waiting days and Illness Benefit can start on day 4." },
...
const esResearch: LocalePost = {
  ...
  article: {
    ...
    author: TEAM_AUTHOR,
    reviewLine: "Se requiere revisión clínica y lingüística antes de publicar.",
...
const cs: LocalePost = {
  ...
  article: {
    ...
    author: TEAM_AUTHOR,
    reviewLine: "Před zveřejněním je nutná klinická a jazyková kontrola.",
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Ne. Pokud máte k dispozici všech pět dnů zákonné nemocenské, Illness Benefit obvykle začíná šestým dnem. Pokud jste u zaměstnavatele méně než 13 týdnů a jinak podmínky splňujete, následují tři čekací dny a dávka může začít 4. dne.",
      },
      {
...
const roResearch: LocalePost = {
  ...
  article: {
    ...
    author: TEAM_AUTHOR,
    reviewLine: "Revizuirea clinică și lingvistică este obligatorie înainte de publicare.",
...
const deResearch: LocalePost = {
  ...
  article: {
    ...
    author: TEAM_AUTHOR,
    reviewLine: "Vor der Veröffentlichung ist eine fachliche und muttersprachliche Prüfung erforderlich.",
