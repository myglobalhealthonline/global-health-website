 ...
 * on 2026-09-02. The general 2026 daily minimum is EUR 9.20 (30% of
 * the EUR 920 RMMG), unless daily reference earnings are lower.
 */
...
const SS_SICKNESS =
  "https://www.seg-social.pt/ptss/pssd/documento/cmdde8gsx000qi12yzi40plc6";
const SICKNESS_LAW =
  ...
  article: {
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          lead("Para trabalhadores por conta de outrem, o subsídio começa normalmente no 4.º dia. Para trabalhadores independentes, incluindo recibos verdes, começa no 11.º dia, após 10 dias de espera."),
          p("Internamento, cirurgia de ambulatório e tuberculose estão entre as situações sem espera."),
          p("Uma autodeclaração pode justificar uma ausência curta, mas não cria por si só direito ao subsídio. Veja a diferença no guia sobre <a href=\"https://www.myglobalhealth.online/portugal/pt/blog/autodeclaracao-de-doenca-ou-baixa-medica\">autodeclaração e baixa médica</a>."),
        ],
      },
      {
        id: "minimo",
        ...
        blocks: [
          lead("Na regra geral, o mínimo diário do subsídio em 2026 é 9,20 €, correspondente a 30% da remuneração mínima mensal garantida de 920 €, salvo se a própria remuneração de referência diária for inferior."),
    ...
    disclaimer: "Informação geral sobre Portugal em 2026; não substitui aconselhamento médico, jurídico ou laboral, nem uma decisão da Segurança Social.",
  } satisfies Article,
};
...
const en: LocalePost = {
  ...
  excerpt: "The 2026 sickness benefit rates, reference earnings, waiting days and a worked example for Portugal.",
  seoTitle: "Portugal sick pay: how much you receive in 2026",
  seoDescription: "See Portugal's 55% to 75% sickness benefit rates, the reference-earnings formula, waiting days and a worked 2026 example.",
  category: "Sick leave",
  article: {
    lang: "en-PT",
    tagline: "Healthcare in Portugal, explained clearly",
    categoryLabel: "Sick leave",
    categoryHref: site("en", "/blog"),
    eyebrow: "Portugal · 2026 rates",
    h1: "Portugal sick pay: how much you receive and how it is calculated",
    deck: "The amount depends on your registered earnings and the number of payable days.",
    intro: "In 2026, Portugal's <strong>sickness benefit</strong> generally pays 55% of daily reference earnings for the first 30 days, 60% for days 31 to 90, 70% for days 91 to 365 and 75% after that. Registered earnings, payable days and the Segurança Social decision determine the final amount. Your latest net salary is not the basis of the calculation.",
    facts: [
      "55% for the first 30 days, followed by 60%, 70% and 75%",
      "The usual formula uses six months of registered earnings",
      "A medical certificate does not guarantee the benefit",
    ],
    primaryCta: { label: "Book a medical assessment", href: site("en", "/services/baixa-medica") },
    secondaryCta: { label: "Speak to our team", href: site("en", "/contact") },
    panelChip: "At a glance",
    panelParas: [
      "The calculation uses declared earnings, not take-home pay.",
      "Waiting days reduce the payment for a short absence.",
      "Segurança Social decides the final amount.",
    ],
    ...
    sections: [
      {
        ...
        h2: "How much sick leave pays in Portugal in 2026",
        blocks: [
          lead("The rate changes according to the total certified duration of incapacity."),
          ul([
            "<strong>Up to 30 days:</strong> 55% of daily reference earnings.",
            "<strong>Days 31 to 90:</strong> 60%.",
            "<strong>Days 91 to 365:</strong> 70%.",
            "<strong>More than 365 days:</strong> 75%.",
          ]),
          p("Each rate applies to that stage. At 55% or 60%, certain family or low-income conditions may add five percentage points."),
          cite(`Rates and increases checked on 25 August 2026 against the <a href="${SS_SICKNESS}" rel="nofollow noopener" target="_blank">Segurança Social portal</a> and Portugal's <a href="${SICKNESS_LAW}" rel="nofollow noopener" target="_blank">consolidated sickness-benefit legislation</a>.`),
        ],
      },
      {
        id: "calculation",
        nav: "Calculation",
        eyebrow: "The formula",
        h2: "How to estimate Portuguese sickness benefit",
        blocks: [
          lead("In the usual case, daily reference earnings are calculated as R ÷ 180."),
          p("R is the remuneration registered in the first six of the previous eight months. Holiday and Christmas allowances are excluded, and net salary does not replace the official record."),
          warn("A calculator does not decide your payment", "It explains the formula. Segurança Social calculates the benefit from your record."),
        ],
      },
      {
        id: "example",
        nav: "Example",
        eyebrow: "Estimate",
        h2: "A worked example of Portugal sick pay",
        blocks: [
          lead("With €7,200 of eligible registered earnings, the daily reference amount is €40. At 55%, the indicative daily benefit is €22."),
          p("For an employee certified as unfit for work for 20 days, with a three-day waiting period, the simple calculation is 17 × €22 = €374. Exceptions, earlier periods of sick leave and your contribution status can change the official result."),
        ],
      },
      {
        id: "waiting-period",
        ...
        h2: "When Portuguese sick pay starts",
        blocks: [
          lead("Employees are usually paid from the fourth day. For self-employed workers, including people working with recibos verdes, payment starts on the eleventh day after a ten-day waiting period."),
          p("Hospital admission, outpatient surgery and tuberculosis are among the situations with no waiting period."),
          p("An autodeclaração may justify a short absence but does not create a benefit entitlement. Our guide to <a href=\"https://www.myglobalhealth.online/portugal/en/blog/self-certification-sick-leave-portugal\">self-certification and medical sick leave</a> explains the distinction."),
        ],
      },
      {
        id: "minimum",
        nav: "Legal minimum",
        eyebrow: "Base amount",
        h2: "The 2026 IAS, daily minimum and possible increase",
        blocks: [
          lead("Under the general rule, the 2026 daily minimum is €9.20, equal to 30% of Portugal's €920 guaranteed monthly minimum wage, unless your daily reference earnings are lower."),
          p("At the 55% and 60% rates, Segurança Social checks whether you qualify for the statutory increase of five percentage points."),
          cite(`The IAS figure is confirmed by <a href="${IAS_2026}" rel="nofollow noopener" target="_blank">Portaria 480-A/2025/1</a>.`),
        ],
      },
      {
        id: "confirm",
        nav: "Check the amount",
        eyebrow: "Next step",
        h2: "What to check before relying on an estimate",
        blocks: [
          lead("Have your CIT dates, employment status and registered earnings to hand."),
          ul([
            "Check the start date and certified duration.",
            "Confirm which months were used for reference earnings.",
            "Identify the waiting days or any applicable exception.",
            `Check the claim in <a href="${SS_DIRETA}" rel="nofollow noopener" target="_blank">Segurança Social Direta</a>.`,
          ]),
          p("If the amount is wrong, late or refused, check the record in Segurança Social Direta and ask Segurança Social for an explanation. The clinic explains certification, not benefit calculations or appeals."),
          p(`For a clinical assessment, see our <a href="${site("en", "/services/baixa-medica")}">online sick-leave service in Portugal</a>. The doctor cannot guarantee a CIT, benefit entitlement or amount.`),
        ],
      },
    ],
    linksEyebrow: "Global Health Portugal",
    linksH2: "Information and assessment",
    linksLead: "The clinic assesses your health. Segurança Social decides the benefit.",
    links: [
      { label: "Sick-leave assessment", href: site("en", "/services/baixa-medica") },
      { label: "Self-certification or medical sick leave", href: site("en", "/blog/self-certification-sick-leave-portugal") },
      { label: "Doctors in Portugal", href: site("en", "/doctors") },
      { label: "Contact Global Health", href: site("en", "/contact") },
    ],
    ctaBox: {
      h3: "Do you need a medical assessment?",
      text: "A doctor assesses your incapacity. Segurança Social decides the sickness benefit.",
      primary: { label: "Book an appointment", href: site("en", "/services/baixa-medica") },
      secondary: { label: "Contact us", href: site("en", "/contact") },
    },
    sourcesEyebrow: "Official sources",
    sourcesH2: "Rules consulted",
    sourcesLead: "Rules checked on 25 August 2026.",
    sources: [
      { label: "Segurança Social — Sickness benefit", href: SS_SICKNESS },
      { label: "Diário da República — consolidated legislation", href: SICKNESS_LAW },
      { label: "Segurança Social Direta — check your claim", href: SS_DIRETA },
    ],
    sourcesNote: "Check the decision for your own claim in Segurança Social Direta.",
    faqEyebrow: "Frequently asked questions",
    faqH2: "Questions about Portuguese sick-pay amounts",
    faqs: [
      { q: "How much do you receive for the first 30 days?", a: "Generally, 55% of daily reference earnings for payable days, not necessarily 55% of net salary." },
      { q: "Are the first three days paid?", a: "As a rule, employees are not paid for the first three days. Some officially recognised situations have no waiting period." },
      { q: "Does an autodeclaração entitle you to sickness benefit?", a: "Not by itself. Justifying an absence and meeting the conditions for a cash benefit are separate matters." },
      { q: "What if the amount is wrong or does not arrive?", a: "Check the record in Segurança Social Direta and ask Segurança Social for clarification. The clinic does not decide calculations or appeals." },
    ],
    disclaimerTitle: "Medical and social-security information",
    disclaimer: "General information about Portugal in 2026; it does not replace medical, legal or employment advice, or a decision by Segurança Social.",
  } satisfies Article,
};
...
const de: LocalePost = {
  ...
  excerpt: "Die Leistungssätze 2026, das Referenzeinkommen, die Karenztage und eine Beispielrechnung für das portugiesische Krankengeld.",
  seoTitle: "Krankengeld Portugal: Höhe und Berechnung 2026",
  seoDescription: "Portugiesisches Krankengeld 2026: Sätze von 55 % bis 75 %, Referenzeinkommen, Karenztage und eine verständliche Beispielrechnung.",
  category: "Krankmeldung",
  article: {
    lang: "de-PT",
    tagline: "Medizin in Portugal, verständlich erklärt",
    categoryLabel: "Krankmeldung",
    categoryHref: site("de", "/blog"),
    eyebrow: "Portugal · Werte 2026",
    h1: "Krankengeld in Portugal: Höhe und Berechnung",
    deck: "Die Höhe hängt vom registrierten Einkommen und den zahlbaren Tagen ab.",
    intro: "Das portugiesische <strong>Krankengeld</strong> beträgt 2026 im Regelfall 55 % des täglichen Referenzeinkommens bis Tag 30, 60 % für Tag 31 bis 90, 70 % für Tag 91 bis 365 und danach 75 %. Registrierte Entgelte, zahlbare Tage und die Entscheidung der Segurança Social bestimmen den Betrag. Das Nettogehalt ist nicht die Berechnungsgrundlage.",
    facts: [
      "55 % bis Tag 30, danach 60 %, 70 % und 75 %",
      "Die übliche Formel verwendet sechs Monate registrierter Entgelte",
      "Die ärztliche Bescheinigung garantiert die Leistung nicht",
    ],
    primaryCta: { label: "Ärztliche Beurteilung buchen", href: site("de", "/services/baixa-medica") },
    secondaryCta: { label: "Mit dem Team sprechen", href: site("de", "/contact") },
    panelChip: "Kurz erklärt",
    panelParas: [
      "Die Berechnung beruht auf gemeldeten Entgelten, nicht auf dem Nettolohn.",
      "Karenztage verringern die Zahlung bei einer kurzen Krankschreibung.",
      "Den endgültigen Betrag bestimmt die Segurança Social.",
    ],
    author: { initials: "RR", name: "Dr Rui Diogo Rodrigues", line: "Arzt für Allgemeinmedizin · Global Health Portugal" },
    navLabel: "In diesem Ratgeber",
    sections: [
      {
        id: "prozentsaetze",
        nav: "Leistungssätze",
        eyebrow: "Offizielle Sätze",
        h2: "Wie viel Krankengeld 2026 in Portugal gezahlt wird",
        blocks: [
          lead("Der Leistungssatz richtet sich nach der gesamten bescheinigten Dauer der Arbeitsunfähigkeit."),
          ul([
            "<strong>Bis 30 Tage:</strong> 55 % des täglichen Referenzeinkommens.",
            "<strong>Vom 31. bis zum 90. Tag:</strong> 60 %.",
            "<strong>Vom 91. bis zum 365. Tag:</strong> 70 %.",
            "<strong>Mehr als 365 Tage:</strong> 75 %.",
          ]),
          p("Jeder Satz gilt für seinen Abschnitt. Bei 55 % und 60 % können bestimmte familiäre Umstände oder ein niedriges Einkommen fünf Prozentpunkte hinzufügen."),
          cite(`Sätze und Erhöhungen geprüft am 25. August 2026 im <a href="${SS_SICKNESS}" rel="nofollow noopener" target="_blank">Portal der Segurança Social</a> und im <a href="${SICKNESS_LAW}" rel="nofollow noopener" target="_blank">konsolidierten portugiesischen Krankengeldrecht</a>.`),
        ],
      },
      {
        id: "berechnung",
        nav: "Berechnung",
        eyebrow: "Die Formel",
        h2: "So schätzen Sie das portugiesische Krankengeld",
        blocks: [
          lead("Im Regelfall wird das tägliche Referenzeinkommen mit der Formel R ÷ 180 berechnet."),
          p("R umfasst die registrierten Entgelte in den ersten sechs der vorherigen acht Monate. Urlaubs- und Weihnachtsgeld bleiben unberücksichtigt; der Nettolohn ersetzt die amtlichen Daten nicht."),
          warn("Ein Rechner entscheidet nicht über die Leistung", "Er erklärt die Formel. Den Betrag berechnet die Segurança Social aus Ihrem Versicherungsverlauf."),
        ],
      },
      {
        id: "beispiel",
        nav: "Beispiel",
        eyebrow: "Schätzung",
        h2: "Beispiel für die Krankengeldberechnung",
        blocks: [
          lead("Bei 7.200 € berücksichtigungsfähigem Entgelt beträgt das tägliche Referenzeinkommen 40 €. Bei einem Satz von 55 % ergibt sich ein vorläufiger Tagesbetrag von 22 €."),
          p("Für einen Arbeitnehmer mit 20 bescheinigten Krankheitstagen und drei Karenztagen lautet die vereinfachte Rechnung 17 × 22 € = 374 €. Ausnahmen, frühere Krankschreibungen und der Versicherungsstatus können das amtliche Ergebnis verändern."),
        ],
      },
      {
        id: "karenz",
        nav: "Karenztage",
        eyebrow: "Zahlungsbeginn",
        h2: "Ab wann das Krankengeld gezahlt wird",
        blocks: [
          lead("Arbeitnehmer erhalten die Leistung normalerweise ab dem vierten Tag. Bei Selbstständigen, einschließlich Personen mit recibos verdes, beginnt sie nach zehn Karenztagen am elften Tag."),
          p("Bei stationärer Aufnahme, ambulanter Operation und Tuberkulose entfällt die Wartezeit unter anderem."),
          p("Eine autodeclaração kann eine kurze Abwesenheit rechtfertigen, begründet aber keinen Leistungsanspruch. Unser Ratgeber zu <a href=\"https://www.myglobalhealth.online/portugal/de/blog/krankmeldung-selbsterklaerung-portugal\">Selbsterklärung und ärztlicher Krankmeldung</a> erklärt den Unterschied."),
        ],
      },
      {
        id: "minimum",
        nav: "Gesetzliches Minimum",
        eyebrow: "Basisbetrag",
        h2: "IAS, Tagesminimum und mögliche Erhöhung",
        blocks: [
          lead("Das tägliche Mindestkrankengeld beträgt 2026 im Regelfall 9,20 €, entsprechend 30 % des garantierten monatlichen Mindestlohns von 920 €, sofern das tägliche Referenzeinkommen nicht niedriger ist."),
          p("Bei den Sätzen von 55 % und 60 % prüft die Segurança Social, ob ein Anspruch auf die gesetzliche Erhöhung um fünf Prozentpunkte besteht."),
          cite(`Der IAS wurde durch die <a href="${IAS_2026}" rel="nofollow noopener" target="_blank">Portaria 480-A/2025/1</a> bestätigt.`),
        ],
      },
      {
        id: "pruefen",
        ...
        h2: "Was Sie prüfen sollten, bevor Sie mit dem Betrag rechnen",
        blocks: [
          lead("Halten Sie die Daten des CIT, Ihren Erwerbsstatus und die registrierten Entgelte bereit."),
          ul([
            "Prüfen Sie Beginn und bescheinigte Dauer.",
            "Sehen Sie nach, welche Monate für das Referenzeinkommen verwendet wurden.",
            "Ermitteln Sie die Karenztage oder eine anwendbare Ausnahme.",
            `Prüfen Sie die Bearbeitung in <a href="${SS_DIRETA}" rel="nofollow noopener" target="_blank">Segurança Social Direta</a>.`,
          ]),
          p("Ist der Betrag falsch, verspätet oder abgelehnt, prüfen Sie die Daten in Segurança Social Direta und fragen Sie die Segurança Social. Die Praxis erklärt die Bescheinigung, nicht Berechnung oder Rechtsmittel."),
          p(`Für eine medizinische Beurteilung finden Sie hier unsere <a href="${site("de", "/services/baixa-medica")}">Online-Sprechstunde zur baixa médica in Portugal</a>. Der Arzt kann weder CIT noch Anspruch oder Betrag garantieren.`),
        ],
      },
    ],
    linksEyebrow: "Global Health Portugal",
    linksH2: "Information und Beurteilung",
    linksLead: "Die Praxis beurteilt die Arbeitsunfähigkeit. Über die Leistung entscheidet die Segurança Social.",
    links: [
      { label: "Ärztliche Beurteilung zur baixa médica", href: site("de", "/services/baixa-medica") },
      { label: "Selbsterklärung oder ärztliche Krankmeldung", href: site("de", "/blog/krankmeldung-selbsterklaerung-portugal") },
      { label: "Ärzte in Portugal", href: site("de", "/doctors") },
      { label: "Global Health kontaktieren", href: site("de", "/contact") },
    ],
    ctaBox: {
      h3: "Benötigen Sie eine ärztliche Beurteilung?",
      text: "Ein Arzt beurteilt Ihre Arbeitsunfähigkeit. Über das Krankengeld entscheidet die Segurança Social.",
      primary: { label: "Termin buchen", href: site("de", "/services/baixa-medica") },
      secondary: { label: "Kontakt", href: site("de", "/contact") },
    },
    sourcesEyebrow: "Offizielle Quellen",
    sourcesH2: "Geprüfte Regeln",
    sourcesLead: "Regeln geprüft am 25. August 2026.",
    sources: [
      { label: "Segurança Social — Krankengeld", href: SS_SICKNESS },
      { label: "Diário da República — konsolidiertes Recht", href: SICKNESS_LAW },
      { label: "Segurança Social Direta — Verfahren prüfen", href: SS_DIRETA },
    ],
    sourcesNote: "Prüfen Sie die Entscheidung in Ihrem Verfahren über Segurança Social Direta.",
    faqEyebrow: "Häufige Fragen",
    faqH2: "Fragen zur Höhe des Krankengelds",
    faqs: [
      { q: "Wie viel erhält man in den ersten 30 Tagen?", a: "Im Regelfall sind es 55 % des täglichen Referenzeinkommens für zahlbare Tage. Das sind nicht zwingend 55 % des Nettogehalts." },
      { q: "Werden die ersten drei Tage bezahlt?", a: "Für Arbeitnehmer in der Regel nicht. In bestimmten amtlich geregelten Situationen entfällt die Karenzzeit." },
      { q: "Begründet eine autodeclaração einen Anspruch auf Krankengeld?", a: "Nein, nicht allein. Die Rechtfertigung einer Abwesenheit und die Voraussetzungen für eine Geldleistung sind zwei verschiedene Fragen." },
      { q: "Was kann ich tun, wenn der Betrag falsch ist oder nicht ankommt?", a: "Prüfen Sie Entgelte, Tage und Entscheidung in Segurança Social Direta und bitten Sie die Segurança Social um Auskunft. Die Praxis entscheidet weder über die Berechnung noch über ein Rechtsmittel." },
    ],
    disclaimerTitle: "Medizinischer und sozialrechtlicher Hinweis",
    disclaimer: "Allgemeine Informationen zu Portugal im Jahr 2026; sie ersetzen weder medizinische, rechtliche oder arbeitsrechtliche Beratung noch eine Entscheidung der Segurança Social.",
  } satisfies Article,
};
...
const es: LocalePost = {
  ...
  article: {
    ...
    author: { initials: "RR", name: "Dr Rui Diogo Rodrigues", line: "Médico de Medicina General y Familiar · Global Health Portugal" }, navLabel: "En esta guía",
    sections: [
    ...
    disclaimerTitle: "Información médica y de seguridad social", disclaimer: "Información general sobre Portugal en 2026; no es asesoramiento médico, jurídico, laboral ni una decisión de la Segurança Social. El documento y la prestación dependen del caso individual.",
  } satisfies Article,
};
...
const cs: LocalePost = {
  ...
  article: {
    ...
    author: { initials: "RR", name: "Dr Rui Diogo Rodrigues", line: "Praktický lékař · Global Health Portugal" }, navLabel: "V tomto průvodci",
    sections: [
    ...
    disclaimerTitle: "Zdravotní a sociální informace", disclaimer: "Obecné informace o Portugalsku v roce 2026, nikoli osobní lékařské, právní, pracovněprávní nebo sociální poradenství.",
  } satisfies Article,
};
...
const ro: LocalePost = {
  ...
  article: {
    ...
    author: { initials: "RR", name: "Dr Rui Diogo Rodrigues", line: "Medic de familie · Global Health Portugal" }, navLabel: "În acest ghid",
    sections: [
    ...
    disclaimerTitle: "Informații medicale și sociale", disclaimer: "Informație generală despre Portugalia în 2026, nu recomandare medicală, juridică, de muncă sau decizie a Segurança Social.",
  } satisfies Article,
};
