...
const pt: LocalePost = {
  ...
  excerpt:
    "Percentagens do subsídio de doença em 2026, cálculo da remuneração de referência, dias de espera e um exemplo sem promessas de valor final.",
  seoTitle: "Baixa médica: quanto se recebe em 2026",
  seoDescription:
    "Veja as taxas de 55% a 75%, como calcular a remuneração de referência e porque os dias de espera alteram o subsídio de doença em 2026.",
  ...
  article: {
    ...
    deck: "A percentagem é simples. O valor real depende da remuneração registada, da duração da incapacidade e dos dias que ficam sem pagamento.",
    intro:
      "Em 2026, o <strong>subsídio de doença</strong> corresponde, na regra geral, a <strong>55% da remuneração de referência até 30 dias</strong>, 60% do 31.º ao 90.º dia, 70% do 91.º ao 365.º e 75% depois disso. Não se aplica a percentagem diretamente ao salário líquido do último mês. A Segurança Social calcula primeiro uma remuneração diária de referência a partir das remunerações registadas e só paga os dias abrangidos depois do período de espera. Por isso, dois trabalhadores com o mesmo salário mensal podem receber montantes diferentes.",
    facts: [
      "55% até 30 dias; 60%, 70% e 75% nos escalões seguintes",
      "A base habitual usa seis meses de remunerações registadas",
    ...
    panelParas: [
      "O valor publicado é diário, mesmo quando a Segurança Social transfere vários dias de uma vez.",
      "A conta começa nas remunerações declaradas, não no valor que entrou na conta no mês passado.",
      "Os primeiros dias podem não ser pagos. Isso explica muitas estimativas acima do valor recebido.",
    ],
    ...
    sections: [
      {
        id: "percentagens",
        nav: "Percentagens",
        eyebrow: "Tabela oficial",
        h2: "Quanto paga a baixa médica em 2026",
        blocks: [
          lead("A percentagem sobe quando a incapacidade se prolonga. Conta a duração total certificada, não cada transferência isolada."),
          ul([
          ...
          p("Os escalões não significam que todos os dias anteriores sejam recalculados à nova taxa. A percentagem aplicável acompanha o período de duração em que cada dia se encontra. A decisão e o processamento pertencem à Segurança Social; uma simulação pessoal é sempre indicativa."),
          cite(`Taxas confirmadas em 24 de agosto de 2026 no <a href="${SS_SICKNESS}" rel="nofollow noopener" target="_blank">portal da Segurança Social</a> e nos artigos 16.º a 19.º do <a href="${SICKNESS_LAW}" rel="nofollow noopener" target="_blank">regime jurídico consolidado</a>.`),
        ],
      },
      {
        id: "referencia",
        nav: "Base da conta",
        eyebrow: "Passo 1",
        h2: "Como se calcula a remuneração de referência",
        blocks: [
          lead("Na situação habitual, a fórmula diária é R ÷ 180. R soma as remunerações registadas nos primeiros seis dos oito meses anteriores ao mês em que começou a incapacidade."),
          p("Se a baixa começar em agosto, por exemplo, o segundo mês anterior é junho. A janela habitual recua então aos seis meses civis anteriores a junho. A formulação legal parece pouco intuitiva, mas evita usar um mês ainda incompleto ou remunerações posteriores ao início da doença."),
          p("Subsídios de férias, de Natal e outros valores de natureza semelhante ficam fora desta soma. Também não se deve substituir a remuneração registada pelo salário líquido: impostos, contribuições, prémios irregulares e deduções tornam esses números diferentes."),
          warn("Não multiplique simplesmente o salário líquido por 55%", "É a forma mais comum de sobrestimar ou subestimar o apoio. Consulte as remunerações registadas na Segurança Social Direta e confirme a janela de referência aplicável ao seu caso."),
        ],
      },
      {
        id: "exemplo",
        nav: "Exemplo",
        eyebrow: "Passo 2",
        h2: "Exemplo de um simulador de baixa médica",
        blocks: [
          lead("Imagine 7.200 € de remunerações elegíveis nos seis meses usados pela Segurança Social. A remuneração diária de referência seria 7.200 ÷ 180 = 40 €."),
          p("Numa incapacidade de 20 dias abrangida pela taxa de 55%, o valor diário indicativo seria 22 €. Um trabalhador por conta de outrem enfrenta, em regra, três dias de espera, pelo que uma estimativa simples consideraria 17 dias pagos: 17 × 22 € = 374 €. Esta conta é pedagógica, não uma decisão de atribuição."),
          p("Se a incapacidade continuar além de 30 dias, os dias seguintes entram no escalão de 60%. Se houver uma nova baixa próxima da anterior, períodos anteriores podem contar para a duração em certas condições. É uma das razões pelas quais uma calculadora genérica pode divergir do processamento oficial."),
          ul([
            "Some apenas remunerações que entram legalmente na referência.",
            "Divida pelo denominador aplicável; na regra habitual, 180.",
            "Aplique a percentagem correspondente a cada fase da duração.",
            "Conte apenas os dias efetivamente pagos depois da espera e de eventuais exclusões.",
          ]),
        ],
      },
      {
        id: "espera",
        nav: "Dias de espera",
        eyebrow: "O detalhe que muda o total",
        h2: "Quando começa o pagamento",
        blocks: [
          lead("Para trabalhadores por conta de outrem, o pagamento começa normalmente no 4.º dia; para trabalhadores independentes, no 11.º."),
          p("Existem outros regimes com espera diferente e situações sem espera, incluindo internamento hospitalar, cirurgia de ambulatório e tuberculose, segundo a informação oficial. A natureza do vínculo e o motivo certificado importam tanto como a duração."),
          p("Uma autodeclaração de doença pode justificar uma ausência curta, mas não cria automaticamente direito ao subsídio. A diferença entre justificar a falta e abrir proteção pecuniária está explicada no nosso guia sobre <a href=\"https://www.myglobalhealth.online/portugal/pt/blog/autodeclaracao-de-doenca-ou-baixa-medica\">autodeclaração e baixa médica</a>."),
          warn("A empresa e a Segurança Social são pagadores diferentes", "O subsídio de doença não é salário e não deve ser confundido com prestações previstas por contrato coletivo, política da empresa ou seguro privado."),
        ],
      },
      {
        id: "minimo-majoracao",
        nav: "Mínimos",
        eyebrow: "Exceções relevantes",
        h2: "Valor mínimo e majoração nos primeiros 90 dias",
        blocks: [
          lead("Com o IAS fixado em 537,13 € para 2026, o mínimo diário legal corresponde, em regra, a 30% do IAS dividido por 30: cerca de 5,37 €."),
          p("Se a própria remuneração de referência diária for inferior, é essa remuneração inferior que limita o apoio. O IAS é atualizado todos os anos; por isso, um artigo ou simulador com o valor de 2025 não deve ser usado para fechar uma conta de 2026."),
          p("Nas taxas de 55% e 60% pode existir uma majoração de cinco pontos percentuais em condições previstas na lei, por exemplo uma remuneração de referência até 500 €, três ou mais descendentes dentro dos limites etários aplicáveis, ou descendente com bonificação por deficiência. As majorações não se acumulam."),
          cite(`O IAS de 537,13 € vigora desde 1 de janeiro de 2026 por força da <a href="${IAS_2026}" rel="nofollow noopener" target="_blank">Portaria n.º 480-A/2025/1</a>. Verifique sempre o valor anual e a decisão individual.`),
        ],
      },
      {
        id: "confirmar",
        nav: "Confirmar",
        eyebrow: "Antes de fazer contas",
        h2: "O que reunir para uma estimativa útil",
        blocks: [
          lead("Uma estimativa melhora muito quando parte do registo contributivo e das datas certificadas, não apenas do salário contratual."),
          ul([
            "Data exata de início e duração indicada no CIT.",
            "Regime: conta de outrem, independente ou outro enquadramento.",
            "Remunerações registadas nos meses usados para a referência.",
            "Existência de internamento, cirurgia de ambulatório ou outra exceção à espera.",
            "Baixa anterior recente que possa influenciar a contagem da duração.",
          ]),
          p(`Se precisa de avaliação clínica da incapacidade, pode conhecer o serviço de <a href="${site("pt", "/services/baixa-medica")}">baixa médica online em Portugal</a>. A emissão de qualquer documento depende da avaliação individual e não garante a atribuição do subsídio.`),
        ],
      },
    ],
    linksEyebrow: "Global Health Portugal",
    linksH2: "Ajuda clínica e administrativa",
    linksLead: "A clínica avalia a saúde e a incapacidade. A Segurança Social decide o direito e o montante.",
    links: [
    ...
    ctaBox: { h3: "Precisa de avaliação médica?", text: "Um médico pode avaliar a situação e explicar o documento adequado. A atribuição e o valor do subsídio cabem à Segurança Social.", primary: { label: "Marcar consulta", href: site("pt", "/services/baixa-medica") }, secondary: { label: "Contactar", href: site("pt", "/contact") } },
    sourcesEyebrow: "Fontes oficiais",
    sourcesH2: "Regras consultadas",
    sourcesLead: "Valores e fórmulas foram verificados em fontes públicas oficiais em 24 de agosto de 2026.",
    sources: [
      { label: "Segurança Social — Subsídio de Doença", href: SS_SICKNESS },
      { label: "Diário da República — regime consolidado", href: SICKNESS_LAW },
      { label: "Diário da República — IAS 2026", href: IAS_2026 },
    ],
    sourcesNote: "As regras podem mudar. Confirme o cálculo e o processamento na Segurança Social Direta.",
    faqEyebrow: "Perguntas frequentes",
    faqH2: "Dúvidas sobre o valor da baixa",
    faqs: [
      { q: "Quanto se recebe de baixa médica nos primeiros 30 dias?", a: "Na regra geral, 55% da remuneração de referência diária nos dias pagos. Não é necessariamente 55% do salário líquido e podem existir dias de espera." },
      { q: "Como faço uma simulação da baixa médica?", a: "Comece pelas remunerações registadas nos seis meses da janela legal, calcule a referência diária, aplique a taxa de cada fase e retire os dias não pagos. O resultado continua a ser indicativo." },
      { q: "Os primeiros três dias de baixa são pagos?", a: "Em regra, não para trabalhadores por conta de outrem: o subsídio começa no quarto dia. Internamento, cirurgia de ambulatório, tuberculose e outras situações previstas podem afastar a espera." },
      { q: "O subsídio aumenta depois de 30 dias?", a: "A taxa passa de 55% para 60% entre o 31.º e o 90.º dia, depois para 70% até 365 dias e 75% além disso. Isso não revaloriza automaticamente todos os dias anteriores." },
      { q: "A autodeclaração de doença dá direito a pagamento?", a: "Não por si só. Pode justificar uma ausência curta, mas o subsídio depende dos requisitos legais e da certificação aplicável. Justificação da falta e prestação pecuniária são questões diferentes." },
    ],
    disclaimerTitle: "Informação médica e social",
    disclaimer: "Artigo AI-assisted, preparado para revisão editorial nativa e clínica. Fornece informação geral sobre Portugal em 2026; não é aconselhamento médico, jurídico, laboral ou uma decisão da Segurança Social. A emissão de CIT e a atribuição do subsídio dependem da avaliação e dos requisitos individuais.",
  } satisfies Article,
};
