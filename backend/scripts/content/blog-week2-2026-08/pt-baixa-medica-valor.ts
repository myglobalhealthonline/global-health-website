  ...
  article: {
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          lead("Employees are usually paid from the fourth day. Self-employed workers are usually paid from the eleventh day."),
    ...
    disclaimer: "This AI-assisted draft is awaiting native editorial and clinical review. It provides general information about Portugal in 2026 and does not replace medical, legal or employment advice, or a decision by Segurança Social.",
  } satisfies Article,
};
...
const de: LocalePost = {
  ...
  article: {
    ...
    reviewLine: "Klinische Prüfung vorgesehen durch Dra. Margarida Domingues e Andrade, Global Health Portugal.",
    ...
    sections: [
      ...
      },
      {
        ...
        blocks: [
          lead("Arbeitnehmer erhalten die Leistung normalerweise ab dem vierten Tag. Bei Selbstständigen beginnt sie üblicherweise am elften Tag."),
    ...
    disclaimer: "Dieser KI-unterstützte Entwurf wartet auf eine muttersprachliche redaktionelle und klinische Prüfung. Er enthält allgemeine Informationen zu Portugal im Jahr 2026 und ersetzt weder medizinische, rechtliche oder arbeitsrechtliche Beratung noch eine Entscheidung der Segurança Social.",
  } satisfies Article,
};
