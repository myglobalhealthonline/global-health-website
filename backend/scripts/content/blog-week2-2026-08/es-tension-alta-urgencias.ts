...
const es: LocalePost = {
  ...
  title: "Tensión alta: síntomas y cuándo acudir a urgencias",
  excerpt:
    "La tensión alta suele no dar síntomas. Aprenda qué señales obligan a llamar al 112, qué hacer ante una cifra muy alta y por qué no debe automedicarse.",
  seoTitle: "Tensión alta: síntomas y cuándo ir a urgencias",
  seoDescription:
    "Síntomas de tensión alta, señales de daño agudo, cuándo llamar al 112 y qué hacer sin automedicarse ni confiar en remedios caseros.",
  ...
  article: {
    ...
    h1: "Tensión alta: síntomas y urgencias",
    deck: "El número importa, pero los síntomas que apuntan a daño agudo son los que convierten una lectura alta en una emergencia.",
    intro:
      "La <strong>tensión alta suele no causar síntomas</strong>. Por eso no puede confirmarse ni descartarse hipertensión según cómo se encuentre. La decisión urgente es distinta: si una lectura muy alta aparece junto con <strong>dolor u opresión en el pecho, falta de aire, debilidad o pérdida de sensibilidad de un lado, dificultad para hablar, confusión, desmayo, pérdida brusca de visión o un dolor de cabeza súbito e intenso</strong>, llame al <strong>112</strong>. Esos signos pueden indicar afectación aguda del corazón, el cerebro, los pulmones, los ojos o los grandes vasos. No espere a que una infusión haga efecto y no tome una dosis extra de un medicamento recetado sin un plan individual indicado por su médico.",
    facts: [
      "La hipertensión suele ser silenciosa",
      "Síntomas de alarma + cifra alta: 112",
      "No duplique ni improvise medicación",
    ],
    primaryCta: { label: "Consulta de medicina general", href: chronicHref("es") },
    secondaryCta: { label: "Consulta de cardiología", href: cardioHref("es") },
    panelChip: "Qué decide este artículo",
    panelParas: [
      "Qué síntomas pueden señalar daño agudo y exigen llamar al 112 sin esperar una consulta por vídeo.",
      "Por qué una cifra muy alta sin síntomas sigue necesitando valoración rápida, aunque no sea automáticamente una emergencia hipertensiva.",
      "Qué puede hacer mientras pide ayuda y qué acciones —dosis extra, captopril prestado o remedios caseros— añaden riesgo.",
      "Cuándo empezar por atención primaria y cuándo cardiología aporta una valoración más especializada.",
    ],
    author: {
      initials: "FM",
    ...
    sections: [
      {
        id: "sintomas",
        nav: "Síntomas",
        eyebrow: "Primera clave",
        h2: "¿Qué síntomas puede dar la tensión alta?",
        blocks: [
          lead("La respuesta más honesta es que, la mayoría de las veces, no da ninguno. Medirse es la única forma de saber qué cifra tiene."),
          p("Dolor de cabeza, mareo, zumbidos, sangrado nasal, palpitaciones o visión borrosa pueden aparecer cuando la presión sube, pero son síntomas inespecíficos. También ocurren por ansiedad, migraña, fiebre, dolor, falta de sueño y muchas otras causas. Sentirse bien tampoco protege: una persona puede mantener cifras elevadas durante años sin notarlo."),
          p("Por eso conviene separar dos preguntas. «¿Tengo hipertensión?» se responde con mediciones repetidas y evaluación clínica. «¿Puede estar ocurriendo algo peligroso ahora?» se responde buscando signos de afectación aguda y valorando la situación completa."),
          ul([
            "Un dolor de cabeza habitual no permite atribuir la causa a la tensión sin más datos.",
            "El mareo no demuestra que la presión esté alta; también puede aparecer cuando está baja.",
            "Una lectura aislada durante dolor o angustia puede ser transitoria, pero no debe ignorarse si es muy alta.",
            "Los síntomas neurológicos, respiratorios o torácicos de inicio brusco cambian la prioridad por completo.",
          ]),
          cite(`La <a href="${FEC_HTA}" rel="nofollow noopener" target="_blank">Fundación Española del Corazón</a> explica que la hipertensión es habitualmente silenciosa y que la detección depende de medirla.`),
        ],
      },
      {
        id: "emergencia",
        nav: "Emergencia",
        eyebrow: "La distinción crítica",
        h2: "Tensión muy alta no siempre significa la misma urgencia",
        blocks: [
          lead("Una emergencia hipertensiva no se define solo por alcanzar un número: existe cuando la elevación se acompaña de lesión aguda o síntomas compatibles con daño de órganos."),
          p("En casa no puede confirmar si hay daño del corazón, cerebro, riñón, retina o aorta. Esa valoración puede requerir exploración, electrocardiograma, analítica, fondo de ojo o imagen. Lo que sí puede reconocer son señales que obligan a actuar como si existiera riesgo hasta que un profesional descarte lo contrario."),
          p("Una cifra en torno a 180/120 mmHg o superior, repetida correctamente, es muy alta. Si no hay signos de alarma, no equivale automáticamente a una emergencia con daño agudo, pero necesita consejo médico rápido el mismo día. Si hay signos de alarma, no siga repitiendo el tensiómetro para ver si baja: llame al 112."),
          warn(
            "No intente diagnosticar una ‘urgencia’ frente a una ‘emergencia’ en casa",
            "La ausencia de dolor no descarta lesión y una cifra algo menor no descarta un ictus, un síndrome coronario o una disección. Los síntomas y el cambio brusco importan tanto como el número.",
          ),
          cite(`La <a href="${ESC_2024}" rel="nofollow noopener" target="_blank">guía ESC 2024</a> diferencia la presión marcadamente elevada de la emergencia hipertensiva con daño agudo de órgano.`),
        ],
      },
      {
        id: "112",
        ...
        blocks: [
          lead("Llame al 112 si una lectura alta coincide con síntomas bruscos que pueden afectar al corazón, el cerebro, la respiración, la visión o la circulación."),
          ul([
            "Dolor, presión o quemazón en el pecho, especialmente con sudor frío, náuseas o dolor hacia brazo, espalda, cuello o mandíbula.",
            "Falta de aire importante, respiración trabajosa, sensación de ahogo en reposo o espuma rosada al toser.",
            "Cara desviada, debilidad o entumecimiento de un lado, dificultad para hablar, entender, caminar o coordinarse.",
            "Confusión nueva, convulsión, desmayo o disminución del nivel de conciencia.",
            "Pérdida súbita de visión, visión doble nueva o un dolor de cabeza explosivo, diferente de los habituales.",
            "Dolor súbito e intenso en pecho, espalda o abdomen con sensación de desgarro, o deterioro rápido durante el embarazo o posparto.",
          ]),
          p("No conduzca usted mismo si tiene síntomas neurológicos, dolor torácico, falta de aire, alteración visual o desmayo. Anote la hora de inicio, desbloquee la puerta si está solo y tenga a mano su lista de medicamentos. Si el 112 le da instrucciones, sígalas."),
          cite(`El <a href="${FARMACIA_URGENCIAS}" rel="nofollow noopener" target="_blank">Consejo General de Colegios Farmacéuticos</a> incluye la crisis hipertensiva en sus pautas de derivación urgente desde farmacia comunitaria.`),
        ],
      },
      {
        id: "que-hacer",
        nav: "Qué hacer",
        eyebrow: "Mientras decide",
        h2: "Qué hacer ante una cifra muy alta sin síntomas de alarma",
        blocks: [
          lead("Si está estable y no hay ningún signo de alarma, siéntese, descanse unos minutos y repita una vez la medición con técnica correcta."),
          ul([
            "Apoye espalda y pies, no cruce las piernas y mantenga el brazo a la altura del corazón.",
            "Compruebe que el manguito es del tamaño adecuado y está sobre la piel, no encima de la ropa.",
            "No hable durante la medición y anote ambas cifras, la hora y cualquier síntoma.",
            "Si sigue en torno a 180/120 mmHg o más, solicite valoración médica urgente el mismo día aunque se encuentre bien.",
            "Si aparece cualquier señal de alarma durante la espera, cambie el plan y llame al 112.",
          ]),
          p(`Para ordenar lecturas de varios días, puede usar el <a href="${toolHref("es")}">registro de tensión arterial</a>. No lo use para retrasar una urgencia ni para decidir dosis. El registro sirve después, cuando un médico revisa el patrón.`),
          p("Si la cifra baja al repetirla, no borre la primera lectura ni dé por cerrado el asunto. Guarde ambas y pida revisión si el episodio fue nuevo, se repite o ocurrió con síntomas. Una consulta por vídeo puede revisar el contexto, pero no puede explorar una urgencia ni sustituir pruebas presenciales."),
        ],
      },
      {
        id: "mitos",
        nav: "Remedios y pastillas",
        eyebrow: "Evite daño añadido",
        h2: "Infusiones, ajo, limón y pastillas: qué no hacer",
        blocks: [
          lead("No existe un remedio de la abuela que trate de forma fiable una posible emergencia hipertensiva, y bajar el número deprisa no es siempre seguro."),
          p("Las búsquedas sobre infusiones, ajo, limón, agua fría o respiración aparecen porque la persona quiere hacer algo inmediatamente. Puede sentarse y respirar con calma mientras pide ayuda, pero eso no trata un ictus, un infarto, un edema pulmonar ni una lesión aórtica. Tomar mucha agua, sal, alcohol o productos herbales también puede interferir con otras enfermedades o medicamentos."),
          p("No tome captopril, nifedipino ni otro antihipertensivo de otra persona. No repita una dosis, no adelante la siguiente y no use una pauta antigua salvo que su propio médico haya dejado por escrito un plan individual para esa situación concreta. Un descenso brusco puede reducir el flujo hacia órganos que ya están en riesgo."),
          warn(
            "‘Natural’ no significa adecuado para una urgencia",
            "Una infusión puede formar parte de su alimentación habitual, pero no sustituye al 112, una evaluación médica ni el tratamiento prescrito. El objetivo inmediato es reconocer daño agudo, no ganar una carrera contra el tensiómetro.",
          ),
        ],
      },
      {
        id: "seguimiento",
        nav: "Seguimiento",
        eyebrow: "Después del episodio",
        h2: "Cuándo empezar por medicina general y cuándo por cardiología",
        blocks: [
          lead("La atención primaria coordina la mayoría de los casos estables; cardiología es útil cuando hay mal control, síntomas, pruebas anormales o sospecha de enfermedad cardiovascular."),
          p(`En una <a href="${chronicHref("es")}">consulta de medicina general y enfermedades crónicas</a> puede revisar la técnica de medida, el registro domiciliario, los medicamentos ya prescritos, la adherencia, posibles efectos adversos y factores como diabetes, riñón, colesterol o peso. Esa es la puerta adecuada cuando no hay síntomas de alarma.`),
          p(`La <a href="${cardioHref("es")}">consulta de cardiología online</a> puede ayudar a interpretar un ECG, Holter, ecocardiograma o informe ya realizado, y a valorar hipertensión difícil de controlar. No sustituye urgencias ni las pruebas que requieren presencia física.`),
          p(`También puede revisar los <a href="${href("es", "/doctors")}">médicos disponibles en España</a> o <a href="${href("es", "/contact")}">contactar con Global Health España</a> si no sabe qué consulta encaja. Si hay signos de alarma, no use estos enlaces: llame al 112.`),
        ],
      },
    ],
    linksEyebrow: "Global Health España",
    linksH2: "Siguientes pasos si no es una urgencia",
    linksLead:
      "Lleve dos o tres días de lecturas bien tomadas, la lista de medicamentos y los informes disponibles. Eso permite decidir el siguiente paso sin convertir una cifra aislada en un diagnóstico.",
    links: [
      { label: "Medicina general y enfermedades crónicas", href: chronicHref("es") },
      { label: "Cardiología online en España", href: cardioHref("es") },
      { label: "Registro de tensión arterial", href: toolHref("es") },
      { label: "Médicos de Global Health España", href: href("es", "/doctors") },
      { label: "Contacto en España", href: href("es", "/contact") },
    ],
    ctaBox: {
      h3: "¿La cifra se repite, pero no hay síntomas de alarma?",
      text: "Empiece por medicina general para revisar el patrón completo. Si hay cardiopatía, pruebas anormales o mal control persistente, cardiología puede completar la valoración.",
      primary: { label: "Consulta de medicina general", href: chronicHref("es") },
      secondary: { label: "Consulta de cardiología", href: cardioHref("es") },
    },
    sourcesEyebrow: "Fuentes clínicas",
    sourcesH2: "Fuentes utilizadas para esta guía",
    sourcesLead:
      "La distinción entre una cifra elevada y daño agudo debe basarse en guías clínicas y protocolos de urgencias, no en consejos virales.",
    sources: [
      { label: "ESC 2024 — presión elevada e hipertensión", href: ESC_2024 },
      { label: "Sociedad Española de Cardiología — guía ESC 2024", href: SEC_ESC_2024 },
      { label: "Fundación Española del Corazón — hipertensión", href: FEC_HTA },
      { label: "Consejo General de Farmacéuticos — urgencias", href: FARMACIA_URGENCIAS },
    ],
    sourcesNote:
      "Los enlaces abren recursos externos. Esta guía no permite diagnosticar ni tratar una emergencia a distancia. Ante signos de alarma, llame al 112.",
    faqEyebrow: "FAQ",
    faqH2: "Preguntas frecuentes sobre tensión alta y urgencias",
    faqs: [
      {
        q: "¿Qué síntomas da la tensión alta?",
        a: "Con frecuencia no da ninguno. Dolor de cabeza, mareo, palpitaciones o visión borrosa pueden aparecer, pero no son específicos. La tensión se conoce midiéndola; la urgencia se valora por la combinación de cifra, inicio y signos de daño agudo.",
      },
      {
        q: "¿Con 180/120 tengo que llamar al 112?",
        a: "Si esa cifra se acompaña de dolor torácico, falta de aire, síntomas neurológicos, confusión, desmayo, pérdida visual o dolor de cabeza súbito e intenso, llame al 112. Sin esos síntomas, repita una vez correctamente y busque valoración urgente el mismo día si persiste.",
      },
      {
        q: "¿Puedo tomar una dosis extra de mi pastilla?",
        a: "No salvo que su propio médico le haya dejado un plan individual y explícito para esa situación. Duplicar, adelantar o mezclar antihipertensivos puede causar una bajada peligrosa y no trata por sí solo una posible lesión de órgano.",
      },
      {
        q: "¿Una infusión o el ajo bajan la tensión rápido?",
        a: "No son tratamientos fiables para una elevación aguda y nunca sustituyen al 112 ni a una valoración médica. Los remedios caseros pueden retrasar la atención y algunos productos interactúan con medicación o enfermedades previas.",
      },
      {
        q: "¿Puedo resolver una cifra alta en consulta online?",
        a: "Una consulta online puede revisar un registro estable y organizar seguimiento, pero no sirve para explorar daño agudo. Con signos de alarma necesita el 112 o urgencias presenciales; sin ellos, atención primaria suele ser la puerta de entrada.",
      },
    ],
    disclaimerTitle: "Aviso médico",
    disclaimer:
      "Escrito por el Dr. Fidel Ernesto Mesa Prado, médico especialista en Cardiología de Global Health España, y revisado clínicamente por el Dr. Eduardo Daniel Rodríguez Olivas, médico general. Contenido elaborado con asistencia de IA, pendiente de revisión editorial nativa y aprobación clínica final antes de publicarse. No sustituye una evaluación individual. No cambie medicación ni dosis sin un plan de su médico. Ante dolor torácico, falta de aire, síntomas neurológicos, confusión, desmayo o pérdida súbita de visión, llame al 112.",
  } satisfies Article,
};
