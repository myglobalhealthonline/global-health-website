...
const en: LocalePost = {
  ...
  article: {
      ...
      },
      {
        ...
        blocks: [
          ...
          ul([
            ...
            "If the result remains around 180/120 mmHg or higher, seek urgent medical assessment that day.",
          ]),
    ...
    faqs: [
      ...
      { q: "Should I call 112 for a reading of 180/120?", a: "Call 112 if it occurs with chest pain, breathlessness, neurological symptoms, confusion, fainting, loss of vision or a sudden severe headache. Without those symptoms, repeat the reading once correctly and seek urgent same-day assessment if it remains high." },
...
const de: LocalePost = {
  ...
  article: {
      ...
      },
      {
        ...
        blocks: [
          ...
          ul([
            ...
            "Bleibt der Wert bei etwa 180/120 mmHg oder höher, lassen Sie sich noch am selben Tag dringend ärztlich beurteilen.",
          ]),
    ...
    faqs: [
      ...
      { q: "Muss ich bei 180/120 den Notruf 112 wählen?", a: "Wählen Sie 112, wenn Brustschmerz, Atemnot, neurologische Beschwerden, Verwirrtheit, Ohnmacht, Sehverlust oder ein plötzlich starker Kopfschmerz hinzukommen. Ohne solche Beschwerden einmal korrekt nachmessen und bei anhaltend hohem Wert noch am selben Tag dringend abklären lassen." },
