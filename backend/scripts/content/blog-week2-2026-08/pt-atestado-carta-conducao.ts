...
const pt: LocalePost = {
  ...
  title: "Atestado médico para carta de condução: grupos 1 e 2, online e sem surpresas",
  excerpt:
    "O atestado médico para carta de condução não segue a mesma lógica para todos os condutores. Explicamos a diferença entre os grupos 1 e 2, quando entra avaliação psicológica, como o pedido chega ao IMT e o que uma consulta online pode resolver.",
  seoTitle: "Atestado médico carta condução: grupos 1 e 2",
  seoDescription:
    "Atestado médico para carta de condução em Portugal: grupos 1 e 2, renovação online, avaliação psicológica e envio eletrónico ao IMT.",
  ...
  article: {
    ...
    deck: "O documento não serve apenas para “assinar um papel”. Serve para confirmar, perante o IMT, se continua clinicamente apto a conduzir na categoria em causa.",
    intro:
      "O <strong>atestado médico para carta de condução</strong> é a declaração clínica usada no processo de emissão ou renovação do título de condução em Portugal. A regra prática é simples: o <strong>Grupo 1</strong> e o <strong>Grupo 2</strong> não têm o mesmo grau de exigência, e a idade do condutor, os antecedentes clínicos, a medicação e o tipo de carta mudam o que o médico tem de confirmar. Em muitos casos, o processo segue por <strong>via eletrónica para o IMT</strong>; noutros, entra também uma <strong>avaliação psicológica</strong>. O que uma consulta séria pode fazer é dizer-lhe se tem elementos suficientes para emitir o atestado e se precisa de passos adicionais. O que não pode fazer é garantir, à partida, que o documento será emitido.",
    facts: [
      "Grupo 1 e Grupo 2 têm requisitos diferentes",
      "IMT recebe o processo por via eletrónica em muitos casos",
      "Avaliação psicológica pode ser exigida",
    ],
    primaryCta: { label: "Marcar consulta para certificado de condução", href: href("pt", "/services/certificado-medico-carta-de-conducao") },
    secondaryCta: { label: "Regras do IMT", href: IMT_REVALIDACAO },
    panelChip: "O que este guia responde",
    panelParas: [
      "Quem normalmente entra no Grupo 1 e no Grupo 2, e porque isso altera o exame e a responsabilidade do médico.",
      "Quando a renovação pode correr online e quando surgem passos extra, como avaliação psicológica ou documentação adicional.",
      "Porque um atestado não é um direito automático: é uma decisão clínica ligada ao regulamento da aptidão para conduzir.",
    ],
    author: {
      initials: "RR",
    ...
    reviewLine:
      "Revisto clinicamente pela Dra. Margarida Domingues e Andrade, médica de Medicina Geral e Familiar, Global Health Portugal.",
    navLabel: "Neste artigo",
    sections: [
      {
        id: "grupos",
        nav: "Grupos",
        eyebrow: "Base do processo",
        h2: "Grupo 1 e Grupo 2: não são a mesma carta nem o mesmo risco",
        blocks: [
          lead("É aqui que a maior parte das confusões começa. O mesmo nome de documento é usado para categorias de condução que o regulamento trata de forma diferente."),
          p("No uso corrente, <strong>Grupo 1</strong> cobre as categorias ligeiras de utilização mais comum. O <strong>Grupo 2</strong> cobre categorias pesadas e profissionais, onde o padrão de aptidão é mais exigente porque o risco para terceiros também é maior. Isto afeta o exame clínico, a atenção dada à visão, ao controlo de doenças crónicas, à medicação com impacto na condução e à eventual necessidade de pareceres complementares."),
          ul([
            "<strong>Grupo 1</strong> tende a corresponder às cartas ligeiras usadas no dia a dia.",
            "<strong>Grupo 2</strong> aplica-se a categorias profissionais e de maior responsabilidade, com requisitos clínicos mais apertados.",
            "A mesma doença ou a mesma medicação pode ter impacto diferente consoante o grupo e a função do condutor.",
            "A idade do condutor e o momento da renovação também alteram a avaliação exigida pelo IMT.",
          ]),
          p("É por isso que um médico responsável não responde “sim” ou “não” ao telefone sem perceber <strong>que categoria está em causa</strong>. Um pedido de renovação de um condutor profissional não se trata como uma simples renovação de carta ligeira sem comorbilidades."),
          cite(`Enquadramento oficial: <a href="${IMT_REQUISITOS}" rel="nofollow noopener" target="_blank">IMT — carta de condução</a> · <a href="${IMT_REVALIDACAO}" rel="nofollow noopener" target="_blank">IMT — revalidação</a>.`),
        ],
      },
      {
        id: "quando-precisa",
        nav: "Quando precisa",
        eyebrow: "Situações",
        h2: "Quando o atestado entra no processo",
        blocks: [
          lead("Não aparece apenas na primeira emissão. O atestado pode ser pedido na inscrição, na revalidação e sempre que exista uma razão clínica ou regulamentar para o IMT voltar a confirmar a aptidão."),
          p("Quem pesquisa <em>renovação da carta de condução online</em> quer saber se o procedimento é administrativo ou médico. A resposta é: é os dois. A parte administrativa pode ser iniciada online, mas o <strong>atestado continua a depender de observação clínica adequada</strong>. Se existe obrigação de o apresentar, não há atalho digital que substitua a avaliação."),
          ul([
            "Emissão inicial, quando a categoria ou a situação do condutor o exige.",
            "Revalidação periódica, nos prazos definidos pelo IMT para a categoria e idade.",
            "Casos em que existe doença, cirurgia, limitação funcional ou medicação que obriga a nova verificação da aptidão.",
            "Pedidos em que o IMT exige elementos complementares antes de concluir o processo.",
          ]),
          p("O erro mais frequente é presumir que “como a renovação está no portal, o atestado também sai automaticamente”. Não sai. O portal facilita o processo administrativo. O juízo clínico continua a ser do médico."),
          warn("Documento certo, no momento certo", "Se marcar a consulta sem saber a categoria, a idade de renovação ou o que o IMT lhe pediu concretamente, arrisca uma consulta incompleta e uma segunda marcação. Leve sempre a notificação do IMT, se a tiver."),
        ],
      },
      {
        id: "consulta",
        nav: "Na consulta",
        eyebrow: "Avaliação",
        h2: "O que o médico tem de confirmar antes de emitir",
        blocks: [
          lead("O atestado para condução não é um favor administrativo. É uma declaração clínica com responsabilidade profissional."),
          p("O médico tem de avaliar se existe alguma condição que comprometa, de forma temporária ou duradoura, a capacidade de conduzir com segurança. Isso inclui visão, audição quando relevante, mobilidade, controlo de doenças crónicas, história de perda de consciência, perturbações neurológicas, cardiovasculares ou psiquiátricas, e o efeito de medicação com impacto na vigilância ou no tempo de reação."),
          ul([
            "Identificação da categoria de carta e do grupo aplicável.",
            "História clínica atualizada, incluindo internamentos, cirurgias e doença crónica.",
            "Revisão da medicação com potencial efeito sedativo, hipoglicémico ou incapacitante.",
            "Avaliação funcional suficiente para perceber se a condução se mantém segura na categoria em causa.",
            "Necessidade, ou não, de exames ou pareceres adicionais antes da emissão.",
          ]),
          p("Uma consulta online pode resolver muitos destes casos quando o historial é claro, a documentação existe e não há sinais de necessidade de exame físico dirigido. Mas se o quadro exige observação presencial, medição, exame neurológico, confirmação visual mais detalhada ou leitura de relatórios que ainda não tem consigo, o médico vai dizer-lhe isso em vez de assinar por adivinhação."),
          warn("Sem garantia prévia", "Nenhum médico pode garantir um atestado antes de o avaliar. Se alguém lhe prometer o documento no momento da marcação, está a prometer uma conclusão clínica sem avaliação clínica."),
          cite(`Regulação profissional: <a href="${ORDEM_MEDICOS}" rel="nofollow noopener" target="_blank">Ordem dos Médicos</a>. Orientação sanitária geral: <a href="${DGS}" rel="nofollow noopener" target="_blank">DGS</a>.`),
        ],
      },
      {
        id: "psicologica",
        nav: "Avaliação psicológica",
        eyebrow: "Passo adicional",
        h2: "Quando pode ser exigida avaliação psicológica",
        blocks: [
          lead("Nem todos os condutores a precisam, mas também não é um cenário raro. Surge sobretudo quando a categoria, a atividade ou o historial levantam questões sobre aptidões psicológicas para condução."),
          p("Na prática, a avaliação psicológica é mais falada nos processos do <strong>Grupo 2</strong>, em contextos profissionais e em situações em que o regulamento ou o histórico do condutor justificam confirmação adicional. Também pode surgir se houve alterações cognitivas, perturbações do comportamento, consumo problemático de substâncias, ou episódios que obriguem a perceber melhor atenção, julgamento e controlo."),
          ul([
            "Pode ser um requisito de categoria, e não uma desconfiança pessoal.",
            "Pode ser pedida por causa de antecedentes clínicos ou comportamentais relevantes para a condução.",
            "Não substitui a avaliação médica; complementa-a.",
            "Se for necessária, o processo não fica “incompleto por capricho”: fica corretamente condicionado por segurança rodoviária.",
          ]),
          p("Quem tenta evitar este passo só prolonga o processo. O mais eficiente é saber logo na consulta se a situação aponta para avaliação psicológica, reunir o que falta e só depois dar o processo por fechado."),
        ],
      },
      {
        id: "imt-online",
        nav: "IMT online",
        eyebrow: "Fluxo administrativo",
        h2: "Como o atestado segue para o IMT e o que “renovação online” realmente quer dizer",
        blocks: [
          lead("Em muitos casos, a parte visível para o utente é digital, mas isso não significa que o processo seja automático nem que todos os elementos sejam substituíveis por cliques."),
          p("O que interessa ao leitor é isto: se o seu processo admite <strong>submissão eletrónica</strong>, o atestado é integrado no circuito usado pelo IMT para tratar a renovação ou emissão. Isso simplifica a entrega e reduz papel. O que não muda é a origem do documento: o conteúdo clínico nasce da consulta, não do portal."),
          ul([
            "A renovação pode ser iniciada ou acompanhada online, conforme o seu caso e a fase do processo.",
            "O atestado médico entra no mesmo circuito administrativo quando a via eletrónica está disponível.",
            "Se faltar documentação, exame ou avaliação complementar, o processo pára até isso estar resolvido.",
            "Online não significa “sem consulta”; significa apenas “sem deslocações desnecessárias para a parte administrativa”.",
          ]),
          p("Isto é especialmente útil para quem pesquisa <em>renovação carta condução online</em> e <em>certificado renovação carta condução</em>. O que o utilizador quer, na verdade, é menos fricção. Menos fricção existe, sim. Mas não à custa de contornar a aptidão médica."),
          cite(`Procedimento e revalidação: <a href="${IMT_REVALIDACAO}" rel="nofollow noopener" target="_blank">IMT — revalidação da carta de condução</a>.`),
        ],
      },
      {
        id: "nao-emitir",
        ...
        h2: "Quando o atestado pode não ser emitido na hora",
        blocks: [
          lead("A resposta responsável nem sempre é “sim”. E isso não significa que a consulta falhou."),
          p("O atestado pode ficar pendente se o médico precisar de relatórios adicionais, de esclarecer uma cirurgia recente, de perceber melhor o controlo de uma doença, de confirmar a medicação, de aguardar avaliação psicológica ou de recomendar observação presencial. Nalguns casos, pode mesmo concluir que a aptidão não está reunida naquela fase."),
          ul([
            "Faltam relatórios ou exames relevantes.",
            "Existe doença sem controlo clínico suficiente para emitir com segurança.",
            "A medicação atual levanta dúvida razoável sobre vigilância e reação.",
            "A categoria pedida obriga a padrão de aptidão mais exigente do que o que está documentado.",
          ]),
          p("Para o doente, isto é incómodo. Para o médico, é responsabilidade profissional. Para o IMT, é exatamente o ponto do sistema. O objetivo do atestado não é acelerar burocracia; é proteger a segurança rodoviária e o próprio condutor."),
        ],
      },
    ],
    ...
    linksLead:
      "Os nossos médicos em Portugal avaliam o pedido de forma direta: categoria, idade, antecedentes, medicação e necessidade, ou não, de passos complementares antes do envio ao IMT.",
    links: [
      { label: "Consulta para atestado médico da carta de condução", href: href("pt", "/services/certificado-medico-carta-de-conducao") },
      { label: "Os nossos médicos em Portugal", href: href("pt", "/doctors") },
      { label: "Contactar a Global Health Portugal", href: href("pt", "/contact") },
    ],
    ctaBox: {
      h3: "Quer perceber se o seu caso fica resolvido numa só consulta?",
      text: "Uma consulta bem preparada esclarece logo a categoria, a documentação necessária, a eventual avaliação psicológica e se o atestado pode seguir para o IMT sem passos extra.",
    ...
    sourcesH2: "Onde confirmar o processo",
    sourcesLead:
      "Categorias, prazos de revalidação, requisitos médicos e eventual avaliação psicológica dependem do enquadramento legal e das instruções do IMT. Confirme sempre na fonte.",
    sources: [
    ...
    sourcesNote:
      "As ligações abrem nos sites das entidades competentes. A emissão do atestado depende sempre da avaliação médica concreta e do enquadramento legal aplicável à categoria do condutor.",
    faqEyebrow: "FAQ",
    faqH2: "Perguntas frequentes",
    faqs: [
      {
        q: "Quem precisa de atestado médico para carta de condução?",
        a: "Depende da categoria de carta, do momento do processo e do enquadramento definido pelo IMT. O Grupo 1 e o Grupo 2 não seguem o mesmo padrão, e a idade ou uma condição clínica podem obrigar a nova confirmação de aptidão.",
      },
      {
        q: "Grupo 1 e Grupo 2 usam o mesmo atestado?",
        a: "O documento é o mesmo tipo de ato clínico, mas a exigência não é a mesma. O Grupo 2 está sujeito a critérios mais apertados porque envolve categorias profissionais e de maior responsabilidade.",
      },
      {
        q: "A renovação da carta de condução online dispensa consulta?",
        a: "Não. O procedimento administrativo pode correr online, mas o atestado continua a depender de avaliação médica adequada. Online reduz fricção administrativa; não elimina o juízo clínico.",
      },
      {
        q: "Quando é necessária avaliação psicológica?",
        a: "Nem todos os condutores precisam dela. Surge sobretudo em categorias e situações em que o regulamento ou o historial do condutor exigem confirmação adicional das aptidões psicológicas para condução.",
      },
      {
        q: "Uma consulta online garante o certificado para renovar a carta?",
        a: "Não. Pode resolver muitos casos, mas não garante o documento antes da avaliação. Se faltarem relatórios, se houver necessidade de exame presencial ou se a situação apontar para avaliação psicológica, o atestado pode ficar pendente.",
      },
    ],
    disclaimerTitle: "Aviso Médico",
    disclaimer:
      "Escrito pelo Dr Rui Diogo Rodrigues, médico de Clínica Geral e Medicina Familiar da Global Health Portugal, e revisto clinicamente pela Dra. Margarida Domingues e Andrade, médica de Medicina Geral e Familiar. Este artigo contém informação geral sobre o atestado médico para carta de condução em Portugal. Não substitui avaliação clínica individual nem aconselhamento jurídico. A emissão do atestado depende da categoria da carta, da idade, do historial clínico e da observação médica. Em caso de urgência médica, ligue 112.",
  } satisfies Article,
};
