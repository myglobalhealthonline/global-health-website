...
function faq(locale: LocaleCode, reg: string, priceLine: string | null): FaqItem[] {
  ...
  const byLocale: Record<LocaleCode, FaqItem[]> = {
    EN: [
      { question: "How does an online consultation work?", answer: "Book an appointment online, choose an available time, and join your consultation by secure video from your phone or computer. Your doctor will review your symptoms and history and advise on next steps." },
      { question: "Who are the doctors?", answer: `All doctors on Global Health are ${c}. Registration details are shown on each doctor's profile.` },
      { question: "Which languages are available?", answer: "Consultations are available in multiple languages, subject to clinician availability. You can select a doctor by language when booking." },
      { question: "Is an online consultation secure?", answer: "Yes. All consultations are conducted over secure video to national telemedicine standards, and your clinical information is handled confidentially." },
      { question: "How do I book an appointment?", answer: "Choose a service, pick an available time slot, and complete your booking online. You will receive confirmation by email before your appointment." },
