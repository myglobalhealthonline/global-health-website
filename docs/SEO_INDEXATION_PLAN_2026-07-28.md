...
Sitemap contains 1,353 URLs; 49 sample URLs from the first pass were never re-run,
...
### 4.1 Should `/` be in the sitemap?

Currently excluded by design — "a country picker, not a content target". But it earns
