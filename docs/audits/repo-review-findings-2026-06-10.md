...
| H32 | `README.md` (44 KB), `docs/plans/launch-blockers.md` | Docs state payments are "not implemented", doctor portal "out of scope", admin CRUD "deferred" — all three are shipped and live in this repo. | Onboarding developers (and AI agents) make wrong decisions from authoritative-looking docs. | Rewrite the status sections; archive stale reports. |
