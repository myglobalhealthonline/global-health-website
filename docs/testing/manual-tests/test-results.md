...
```powershell
powershell -File docs/testing/manual-tests/run-api-smoke.ps1
powershell -File docs/testing/manual-tests/run-remaining-window-tests.ps1
powershell -File docs/testing/manual-tests/run-final-remaining-tests.ps1
powershell -File docs/testing/manual-tests/run-last-2-percent.ps1
