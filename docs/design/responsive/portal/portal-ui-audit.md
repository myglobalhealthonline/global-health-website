...
Companions: [`LIST_AND_TABLE_INVENTORY.md`](./list-and-table-inventory.md), [`PORTAL_OVERLAY_STACKING_INVENTORY.md`](./portal-overlay-stacking-inventory.md), [`DRAWER_ARCHITECTURE_PLAN.md`](./drawer-architecture-plan.md), shared docs in `../shared/`.
