...
Companion docs: [`CONSISTENCY_REPORT.md`](./consistency-report.md), [`RESPONSIVE_IMPLEMENTATION_PLAN.md`](./responsive-implementation-plan.md), website + portal audits in sibling folders.
...
| Spec | `docs/archive/2026-design-system-v1/design-system-country-homepage.md` §3 | `docs/design/portal-redesign/portal-design-system-v2-obsidian-ivory.md` §6 |
