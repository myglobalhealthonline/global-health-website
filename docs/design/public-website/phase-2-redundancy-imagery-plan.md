...
> **Companion to:** [`public-website-telemedicine-upgrade-plan.md`](telemedicine-upgrade-plan.md) (Phase 1).
> **Authoritative visual spec:** [`DESIGN.md`](../../archive/2026-design-system-v1/design-system-country-homepage.md) (dark forest + lime, Manrope).
