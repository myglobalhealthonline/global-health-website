...
> **Authoritative visual spec:** [`DESIGN.md`](../../archive/2026-design-system-v1/design-system-country-homepage.md) (dark forest + lime, Manrope). `direction.md` / `redesign-audit.md` are **superseded** for their light-hero + Geist recommendations.
...
- **TODO/licensing:** record source + license per committed image in `docs/guides/media-asset-upload.md`; if an image needs owner approval, ship a safe bundled placeholder and flag.
...
**C. Imagery assets**
- [ ] Download + commit vetted Unsplash/Pexels/Pixabay human telemedicine images to `/public/images/**`; record source/license in `docs/guides/media-asset-upload.md`.
...
**Automated** (`pnpm` workspace): `pnpm lint` · `pnpm typecheck` · `pnpm build` · `pnpm --filter frontend test` (vitest) · `pnpm e2e` (Playwright). Keep `docs/testing/manual-tests/test-public-website.md` (TC-PUB-001…029) green.
...
| Doc | Use for |
|---|---|
| [`DESIGN.md`](../../archive/2026-design-system-v1/design-system-country-homepage.md) | **Authoritative** visual spec — palette, surfaces, per-section layout, motion, anti-patterns. Do NOT re-derive tokens. |
| [`direction.md`](../../archive/2026-public-website-redesign/redesign-direction-phase-2.md) | Engineering-rule table, component sketches, anti-pattern list, globals.css additions. **Light-hero + Geist = SUPERSEDED.** |
| [`redesign-report.md`](../../archive/2026-public-website-redesign/redesign-final-report.md) | As-built record of 12 shipped commits + existing `.gh-*` utilities/tokens + **lock list**. |
| [`redesign-audit.md`](../../archive/2026-public-website-redesign/redesign-audit-phase-1.md) | Per-page 0–5 scoring, "must not revert" baseline. |
| [`docs/design/public-website/ux-content-redundancy-audit.md`](ux-content-redundancy-audit.md) · [`docs/design/public-website/frontend-redundancy-ux-audit.md`](frontend-redundancy-ux-audit.md) | **All IA / canonicalization / CTA-reduction / SEO / copy-rewrite decisions.** |
| [`docs/audits/wix-migration-product-audit.md`](../../audits/wix-migration-product-audit.md) | Phase-1 product scope, country-first model, 7 priority decisions. |
| [`docs/plans/next-phases-roadmap.md`](../../plans/next-phases-roadmap.md) | Production handover checklist, phase status, known gaps. |
| [`docs/plans/launch-blockers.md`](../../plans/launch-blockers.md) | Business/legal/deploy blockers. |
| [`docs/testing/manual-tests/test-public-website.md`](../../testing/manual-tests/test-public-website.md) | Public-site acceptance/regression matrix (keep green). |
| [`AI_AGENT_PROMPT_Global_Health.md`](../../archive/2026-wix-rebuild/ai-agent-prompt.md) | Stack, responsive widths, URL-preservation, asset-migration rules. |
