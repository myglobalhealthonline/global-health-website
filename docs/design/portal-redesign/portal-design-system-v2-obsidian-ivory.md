...
> `docs/design/portal-redesign/portal-shared-ui-dependency-map.md` can implement
...
> `docs/design/portal-redesign/portal-shared-ui-dependency-map.md` (blast
> radius) and `docs/design/portal-redesign/portal-design-system-v2-obsidian-ivory.md` (the consolidated spec —
