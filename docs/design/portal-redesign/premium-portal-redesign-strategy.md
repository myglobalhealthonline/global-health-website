...
>
> **Read first:** `docs/design/portal-redesign/portal-shared-ui-dependency-map.md`
> (master dependency reference) and `docs/design/portal-redesign/portal-design-system.md`
...
**Binding design spec:** `docs/design/portal-redesign/portal-design-system.md`. Read it in full
...
1. `docs/design/portal-redesign/portal-shared-ui-dependency-map.md` (mandatory)
2. `docs/design/portal-redesign/portal-design-system.md` (binding spec)
...
`docs/design/portal-redesign/portal-shared-ui-dependency-map.md` §3/§9 in the same
