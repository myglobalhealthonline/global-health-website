...
against docs/plans/portal-implementation/task.md §10 (matrix), §11 (automated regression), §17
(definition of done).
...
`docs/design/responsive/shared/intentional-horizontal-scroll.md`) and the login pattern from
...
(`docs/testing/manual-tests/test-results.md`) so it runs out of the box in this environment.
...
Screenshots written to `docs/plans/portal-implementation/screenshots/after/` (throwaway
