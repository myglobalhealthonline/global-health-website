/**
 * Human-readable timezone labels — mirror of the backend notification helper
 * at backend/src/modules/automation/timezone-label.ts. Kept in sync so the
 * admin appointment overview names a booking's timezone exactly the way the
 * patient's notifications do ("14:00 (Portugal)"), instead of "GMT+1".
 *
