...
export function CookieBanner() {
  ...
  return (
    <div
      ...
      aria-live="polite"
      aria-label={t.title}
      className="fixed bottom-24 left-4 right-4 z-50 mx-auto max-w-2xl rounded-xl border border-slate-200 bg-white p-4 shadow-[0_10px_30px_rgba(15,46,37,0.18)] sm:p-5 md:bottom-4"
