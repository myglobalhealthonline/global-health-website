...
const PHRASES: Record<string, Phrases> = {
  ...
  pt: {
    ...
    body: "Registo, privacidade e orientação de emergência para doentes que marcam neste mercado.",
    doctorsRegistered: (r) => `Médicos inscritos no ${r}`,
    ...
    kReviews: "Avaliações verificadas",
    reviewsText: "Recomendado por doentes no Doctify",
  },
  es: {
    eyebrow: "Atención regulada y verificada",
    headline: "Atención con licencia, verificada localmente.",
    body: "Registro, privacidad y orientación de emergencia para pacientes que reservan en este mercado.",
    doctorsRegistered: (r) => `Todos los médicos colegiados en el ${r}`,
    gdpr: (law, a) => `Cumple ${law} - supervisado por ${a}`,
    standards: (a) => `Estándares clínicos alineados con ${a}`,
    verify: "Verificar",
    emergencyTag: "Emergencia",
    emergencyFallback: (n) =>
      `En caso de emergencia médica llame al ${n} de inmediato. Las consultas online no son adecuadas para emergencias.`,
    kMedical: "Registro médico",
    kData: "Protección de datos",
    kStandards: "Estándares clínicos",
    kComplaints: "Reclamaciones",
    kProvider: "Registro del proveedor",
    kReviews: "Reseñas verificadas",
    reviewsText: "Recomendado por pacientes en Doctify",
  },
  cs: {
    eyebrow: "Regulovaná a ověřená péče",
    headline: "Licencovaná péče, ověřená lokálně.",
    body: "Registrace, ochrana soukromí a pokyny pro nouzové situace pro pacienty rezervující si termín na tomto trhu.",
    doctorsRegistered: (r) => `Všichni lékaři registrováni u ${r}`,
    gdpr: (law, a) => `${law} v souladu - pod dohledem ${a}`,
    standards: (a) => `Klinické standardy v souladu s ${a}`,
    verify: "Ověřit",
    emergencyTag: "Pohotovost",
    emergencyFallback: (n) =>
      `V případě lékařské pohotovosti okamžitě volejte ${n}. Online konzultace nejsou vhodné pro naléhavé případy.`,
    kMedical: "Lékařský registr",
    kData: "Ochrana údajů",
    kStandards: "Klinické standardy",
    kComplaints: "Stížnosti",
    kProvider: "Registrace poskytovatele",
    kReviews: "Ověřené recenze",
    reviewsText: "Doporučeno pacienty na Doctify",
  },
  ro: {
    eyebrow: "Îngrijire reglementată și verificată",
    headline: "Îngrijire autorizată, verificată local.",
    body: "Înregistrare, confidențialitate și îndrumări de urgență pentru pacienții care fac programări pe această piață.",
    doctorsRegistered: (r) => `Toți medicii înregistrați la ${r}`,
    gdpr: (law, a) => `Conform ${law} - supravegheat de ${a}`,
    standards: (a) => `Standarde clinice aliniate cu ${a}`,
    verify: "Verificați",
    emergencyTag: "Urgență",
    emergencyFallback: (n) =>
      `În caz de urgență medicală, sunați imediat la ${n}. Consultațiile online nu sunt potrivite pentru urgențe.`,
    kMedical: "Registru medical",
    kData: "Protecția datelor",
    kStandards: "Standarde clinice",
    kComplaints: "Reclamații",
    kProvider: "Înregistrarea furnizorului",
    kReviews: "Recenzii verificate",
    reviewsText: "Recomandat de pacienți pe Doctify",
  },
  de: {
    eyebrow: "Regulierte & geprüfte Versorgung",
    headline: "Zugelassene Versorgung, lokal geprüft.",
    body: "Registrierung, Datenschutz und Notfallhinweise für Patienten, die in diesem Markt buchen.",
    doctorsRegistered: (r) => `Alle Ärzte bei der ${r} registriert`,
    gdpr: (law, a) => `${law}-konform - beaufsichtigt von der ${a}`,
    standards: (a) => `Klinische Standards abgestimmt mit ${a}`,
    verify: "Überprüfen",
    emergencyTag: "Notfall",
    emergencyFallback: (n) =>
      `Rufen Sie bei einem medizinischen Notfall sofort ${n} an. Online-Konsultationen sind für Notfälle nicht geeignet.`,
    kMedical: "Ärzteregister",
    kData: "Datenschutz",
    kStandards: "Klinische Standards",
    kComplaints: "Beschwerden",
    kProvider: "Anbieterregistrierung",
    kReviews: "Verifizierte Bewertungen",
    reviewsText: "Von Patienten auf Doctify empfohlen",
  },
};
