  ...
  return (
    ...
    >
      <div className="min-w-0">
        <p className="font-semibold">Complete your compliance setup</p>
        <p className="mt-0.5">
          Required before patient-record protections are enforced — takes about 5 minutes.
        </p>
      ...
      <button
        type="button"
        onClick={dismiss}
        aria-label="Dismiss compliance reminder"
