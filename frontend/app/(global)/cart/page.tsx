...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return buildPublicMetadata({ path: "/cart", title: common.flow.cartOpeningTitle, description: common.flow.cartMetaDescription, locale, kind: "page", subtitle: common.cartPage.title, noindex: true });
}
