...
/**
 * Scoped error boundary for /admin/reports that surfaces the real error
 * message + stack on-screen (temporary diagnostic — the shared admin
 * boundary hides it behind a generic message + digest).
 */
export default function AdminReportsError({
  ...
  useEffect(() => {
    console.error("[admin/reports] boundary:", error);
  }, [error]);
