    ...
    return (
      <section className="gh-card p-6 sm:p-8">
        <div className="flex flex-wrap items-center justify-between gap-3">
          ...
          <Link href={`/admin/faqs/${id}`} className="gh-link text-sm text-[var(--color-text-muted)]">
            Cancel
          </Link>
        </div>
    ...
    <section className="gh-card p-6 sm:p-8">
      ...
      <form action={updateAction} className="mt-8 flex flex-col gap-8">
        ...
        <div className="flex flex-wrap items-center gap-3">
          ...
          <Link href={`/admin/faqs/${id}`} className="gh-link text-sm text-[var(--color-text-muted)]">Cancel</Link>
        </div>
      </form>
    </section>
  );
