...
function Section({ icon, title, children }: { icon: React.ReactNode; title: string; children: React.ReactNode }) {
  return (
    <AdminCard className="gh-admin-area-hero gh-admin-area-patients gh-admin-patient-section">
...
function Row({ label, value }: { label: string; value: React.ReactNode }) {
  return (
    <div className="gh-admin-area-hero gh-admin-area-patients gh-admin-patient-row flex items-start justify-between gap-4 border-b border-[var(--color-border)] py-2 last:border-0">
  ...
  return (
    <>
      ...
      <Section icon={<Globe className="size-4" />} title="Patient overview">
        <div className="gh-admin-area-hero gh-admin-area-patients gh-admin-patient-overview-grid grid gap-x-8 gap-y-0 sm:grid-cols-2">
          <div>
      ...
      <Section icon={<ShieldCheck className="size-4" />} title="Verification status">
        <div className="gh-admin-area-hero gh-admin-area-patients gh-admin-patient-verification-grid grid gap-3 sm:grid-cols-2 lg:grid-cols-4">
          {(
            [
