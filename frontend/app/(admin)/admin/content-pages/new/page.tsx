  ...
  return (
    <section className="gh-card p-6 sm:p-8">
      ...
      <form action={createAction} className="mt-6 grid gap-4">
        <input className="gh-input" name="pageKey" placeholder="privacy-policy" required />
        <input className="gh-input" name="title" placeholder="Title" required />
        <textarea className="gh-textarea" name="body" placeholder="Body/content" rows={12} required />
        <div className="grid gap-3 sm:grid-cols-2">
          <select className="gh-select" name="status" defaultValue="DRAFT">
        ...
        <input className="gh-input" name="seoTitle" placeholder="SEO title (optional)" />
        <textarea className="gh-textarea" name="seoDescription" placeholder="SEO description (optional)" rows={2} />
        <input className="gh-input" name="lastReviewedAt" type="datetime-local" />
