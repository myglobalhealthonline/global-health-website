...
export async function GET() {
  ...
  for (const c of countries) {
    ...
    lines.push(`- [${c.name} — See a specialist](${origin}/${slug}/${lang}/see-a-specialist): specialists registered in ${c.name} across cardiology, dermatology, nutrition and more.`);
