        ...
        <Container>
          <div className="mx-auto max-w-3xl text-center">
            <p className="mb-4 text-sm font-semibold uppercase tracking-wide text-teal-700">
              Online medical clinic - Europe-wide
            </p>
            ...
            <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
              <Link
                ...
                className="inline-flex min-h-12 items-center justify-center rounded-full bg-teal-700 px-8 py-3 text-base font-semibold text-white shadow-md transition-colors hover:bg-teal-800"
              >
                {common.cta.primaryBooking}
              </Link>
              <a
                href="#countries"
                className="inline-flex min-h-12 items-center justify-center rounded-full px-8 py-3 text-base font-semibold text-slate-900 underline-offset-4 transition-colors hover:text-teal-700 hover:underline"
              >
                Select your country
              </a>
            </div>
