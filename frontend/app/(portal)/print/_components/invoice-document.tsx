/**
 * The Global Health billing document, drawn once and reused.
 *
 * Both the order invoice (/print/order-invoices/:id) and the membership
 * invoice (/print/subscription-invoices/:id) render through this, so a patient
 * never sees two different-looking documents from the same company. Callers
 * fetch their own payload — the two sources are authorized very differently —
 * and hand it in already shaped.
 */
...
export function InvoiceDocument({
  ...
  data: InvoiceDetail;
  /** Where the screen-only Download button points. */
  downloadHref: string;
}) {
