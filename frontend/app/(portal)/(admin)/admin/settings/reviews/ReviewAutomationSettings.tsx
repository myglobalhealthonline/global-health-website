...
export function ReviewAutomationSettings({ settings }: { settings: AdminReviewSettings }) {
  ...
  return <>
    <FormSection title="Email automation" description="Invite patients after completed consultations. At most one new sequence per patient every 90 days, across countries. Delivery retries do not count as follow-ups.">
    ...
    <FormSection title="Global review accounts" description="Patients choose one available platform. Add Trustpilot when the account is ready; an empty link stays hidden from patients.">
